...
const exercisesUpdates = {
  ...
  15: {
    question: "How did the people justify their idol worship when Abraham questioned them?",
    options: [
      "They admitted the idols were completely useless",
      "They argued that their forefathers had worshipped them",
      "They claimed the idols communicated with them directly"
    ],
    correctAnswer: 1,
    explanation: "They relied on blind imitation of their ancestors to defend their beliefs.",
    type: "multiple-choice"
  },
  16: {
  ...
  18: {
    question: "Why did Abraham smash the idols and hang the axe on the biggest one?",
    options: [
      "Because he accidentally ruined the temple",
      "He wanted to steal precious stones from them",
      "To provide practical proof of their helplessness and foolishness"
    ],
    correctAnswer: 2,
    explanation: "It was a planned move to force the people to realize their gods were powerless.",
    type: "multiple-choice"
  },
  19: {
    question: "What was the idolaters' reaction upon discovering their broken statues?",
    options: [
      "They decided to abandon idol worship immediately",
      "They realized Abraham was right and thanked him",
      "They looked for the culprit and brought Abraham before the people"
    ],
    correctAnswer: 2,
    explanation: "They were shocked and sought to punish the one who destroyed their gods.",
    type: "multiple-choice"
  },
  20: {
  ...
  21: {
    question: "What punishment did the tyrant rulers decide upon for Abraham?",
    options: [
      "They exiled him to a faraway land",
      "They sentenced him to be burned alive in a massive fire",
      "They imprisoned him for life"
    ],
    correctAnswer: 1,
    explanation: "They built a massive fire to burn him as revenge for their gods.",
    type: "multiple-choice"
  },
  22: {
  ...
  25: {
    question: "What led to Hajar becoming Abraham's wife?",
    options: [
      "Sarah had no children and offered Hajar to her husband",
      "Abraham met Hajar during a journey",
      "Nimrod forced him to marry her"
    ],
    correctAnswer: 0,
  ...
  32: {
    question: "How did Abraham and Ishmael react to the dream containing Allah's command?",
    options: [
      "They both demonstrated unconditional submission and readiness to obey",
      "They tried to find a way to avoid the command completely",
      "They argued about the meaning of the dream"
    ],
    correctAnswer: 0,
    explanation: "Both father and son surrendered to the command immediately, proving their deep faith.",
    type: "multiple-choice"
  },
  33: {
...
// Also apply Hotspot checks? The user said some hotspots belong to the next chapter.
// So let's completely regenerate exercises via parsing 'id: XX' blocks.

for (const [id, ex] of Object.entries(exercisesUpdates)) {
  const chapterRegex = new RegExp(`("id":\\s*${id},[\\s\\S]*?"exercises":\\s*\\[\\s*\\{[\\s\\S]*?\\}\\s*\\])`, 'g');
  
  pageStr = pageStr.replace(chapterRegex, (match) => {
    // Generate new exercise block
    let newExStr = '';
