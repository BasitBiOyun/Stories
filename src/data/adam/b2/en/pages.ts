...
): PageData => ({ id, type: 'story', title, image, audioUrl, content, vocabulary, hotspots, animatedWords });
...
const stories: PageData[] = [
  story(
    ...
    ['miraculous', 'fabulous', 'philosophical'],
  ),
  story(
    2,
  ...
  story(
    ...
    ['vicegerent', 'astonishment', 'extraordinary', 'fundamental'],
  ),
  story(
    4,
    ...
    ['offspring', 'alternatives', 'revelation'],
  ),
  story(
    5,
    "Angels' Prostration & Iblis's Arrogance",
    ...
    ['inability', 'obedience', 'unapparent'],
  ),
  story(
    6,
    ...
    ['respectful', 'inhabit', 'outcast', 'deceive'],
  ),
  story(
    7,
    ...
    ['immortals', 'whispered', 'sincere', 'preoccupied'],
  ),
  story(
    8,
    ...
    ['deception', 'evident', 'hayâ', 'forgiveness'],
  ),
  story(
    9,
    ...
    ['regretted', 'mercy', 'repentance', 'prophethood'],
  ),
  story(
    10,
    ...
    ['vicegerency', 'humiliation', 'descended', 'pilgrimage'],
  ),
  story(
    11,
    ...
    ['conflict', 'displacement', 'continuous', 'cultivate'],
  ),
  story(
    12,
    ...
    ['bliss', 'sacrifice', 'insincerity', 'pious'],
  ),
  story(
    13,
    ...
    ['criminal', 'corpse', 'stench', 'preserved', 'rebellious', 'compassion'],
  ),
  story(
    14,
