...
export const adamB2Pages: PageData[] = [
  ...
  },
  {
    ...
    content: "To be a representative, Adam (pbuh) needed some extraordinary qualities. Allah breathed His own spirit into Adam (pbuh) (see Sâd: 72). Also, he had to be taught by Allah. Breathing Allah’s spirit into Adam (pbuh) shows the value that Allah gave him. It also signifies giving Adam (pbuh) life and the beginning of human existence. Allah’s breathing His spirit into Adam (pbuh) distinguishes him from the rest of the creatures, too. Then, He (Allah) taught him all the names.\n\n“And He taught Adam the names, all of them; then He presented them to the angels and said, ‘Tell Me the names of these, if you are sincere.’ They said, ‘Glory be to You! We have no knowledge except what You have taught us. It is You who are the Knowledgeable, the Wise.’ He said, ‘O Adam, tell them their names.’ And when he (Adam) told them their names, He said, ‘Did I not tell you that I know the secrets of the heavens and the earth, and that I know what you reveal and what you conceal?’ (Baqarah: 31-33)\n\nThe statement “Allah taught Adam (pbuh) all the names” points to the breadth of Adam (pbuh)’s knowledge. The names taught to Adam (pbuh) could be the fundamental knowledge of being human, thinking, forming logical judgments, and producing civilization and culture. The knowledge given to Adam (pbuh) represents the beginning of the human capacity to learn, speak language, and use intelligence. The names refer to the fact that knowledge is the basis of science, technology, and culture.",
    vocabulary: [
  ...
  },
  {
    id: 5,
    type: 'story',
    title: 'Angels\' Prostration & Iblis\'s Arrogance - Part 2',
    image: 'https://firebasestorage.googleapis.com/v0/b/gen-lang-client-0373200489.firebasestorage.app/o/adam_b1%2Fimages%2Fadam_b1_chapter_5.png?alt=media&token=d8bcf1b1-a4ff-4768-971f-4893e40bb909',
  ...
  },
  {
    id: 13,
    type: 'story',
    title: 'Habil\'s Response & Human Nature',
