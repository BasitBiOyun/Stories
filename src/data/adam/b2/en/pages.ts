...
export const adamB2Pages: PageData[] = [
  ...
  },
  {
    ...
    animatedWords: ['vicegerent', 'extraordinary', 'fundamental'],
  },
  {
    id: 4,
    type: 'story',
    title: 'Knowledge, Revelation & the Command',
    image: '',
  ...
  },
  {
    ...
    hotspots: [
      { id: 'h6a', x: 30, y: 50, title: 'Life in Paradise', description: 'Adam (pbuh) was now in Paradise and not alone; he had his wife with him.' },
  ...
  },
  {
    ...
    hotspots: [
      { id: 'h7a', x: 30, y: 50, title: 'Manipulation', description: 'He took advantage of Adam (pbuh)’s humanity to manipulate him.' },
  ...
  },
  {
    ...
    animatedWords: ['deception', 'evident', 'hayâ', 'forgiveness', 'unclad'],
  },
  {
    id: 9,
    type: 'story',
  ...
  },
  {
    ...
    content: "Allah knew that Adam (pbuh) and Eve would eat of the tree and descend to Earth. He knew that Satan would violate their innocence. That experience was essential for their life on Earth; it was a cornerstone of their vicegerency. It was meant to teach Adam (pbuh), Eve, and their offspring that Satan is their enemy and that the right path is to act in accordance with what they have heard from the Creator. The Creator is Knower, Powerful, Just, and Merciful.\n\nAdam (pbuh)’s descending to Earth, then, did not imply dishonour or humiliation, but rather it was an honourable and respected settlement on Earth. And thus began the story of humankind and its struggle against Satan on Earth. There are many hadiths about the place of Adam (pbuh)’s descent upon Earth. Ibn Abbas, who narrated many hadiths, said: “Adam (pbuh) descended on land ‘Dihna’ between Mecca and Taif.”\n\nIt is also reported that Adam (pbuh) descended with the Black Stone, a large black stone set into the wall of the Ka’ba in Mecca and said to have come from Paradise.\n\nIbn Umar said that Adam (pbuh) descended on As-Safa and Eve on Al-Marwa, names of two mountains in the neighbourhood of the Sacred House (Ka’ba) in Mecca. Part of the rites of pilgrimage (hajj) includes walking and running between these two hills in remembrance of Hajar's search for water.",
    vocabulary: [
    ...
    hotspots: [
      ...
      { id: 'h10b', x: 70, y: 40, title: 'An Honourable Settlement', description: 'Adam (pbuh)’s descending to Earth, then, did not imply dishonour or humiliation, but rather it was an honourable and respected settlement on Earth.' },
    ],
  ...
  },
  {
    ...
    content: "Ebu Hureyre reported that the Prophet Muhammad (pbuh) said: “The best of days on which the sun has risen is Friday. On this day Adam (pbuh) was created, and on this day he descended to Earth.” (see Müslim, Cum`a 17, 18; also Tirmizî, Cum`a 1, 2; Nesâî, Cum`a 4, 45)\n\nAdam (pbuh) knew that he had said goodbye to peace and left Paradise. On Earth, he had to face conflict and struggle. No sooner had one ended than another began. He also had to work hard to keep himself alive. He had to protect himself with clothes and weapons and protect himself from dangers in the wild.\n\nAbove all, he had to struggle with the spirit of evil. Satan, the cause of his displacement from Paradise, continued to deceive him and his children. Satan wants human beings not to remember Allah, yet the removal of Allah from the human mind means the removal of meaning and purpose from human life.\n\nThe battle between good and evil is continuous, but those who follow Allah's guidance should fear nothing, while those who disobey Allah and follow Iblis will be away from the mercy of Allah along with him. Adam (pbuh) understood all this, and with the knowledge of this suffering, he started his life on Earth.\n\nThe only thing that eased his grief was that he was master of the Earth and had to make it ruled by him. He had to maintain, cultivate, construct, and populate the Earth. He also had to reproduce and raise children who would change and improve the world.",
    vocabulary: [
    ...
    hotspots: [
      { id: 'h11a', x: 30, y: 50, title: 'Earthly Struggle', description: 'On Earth, he had to face conflict and struggle.' },
  ...
  },
  {
    ...
    hotspots: [
      { id: 'h12a', x: 30, y: 50, title: 'Habil’s Offering', description: 'Habil offered his best cattle while Qabil offered his worst grain.' },
      { id: 'h12b', x: 70, y: 40, title: 'Qabil’s Insincerity', description: 'Qabil’s sacrifice was not accepted by Allah because of his insincerity in his offering.' },
    ],
  ...
  },
  {
    id: 13,
    type: 'story',
    title: 'Habil’s Response & Human Moral Capacity',
    ...
    vocabulary: [
      { word: 'aggressive', definition: 'Ready or likely to attack, threaten, or use force.' },
      { word: 'rebellious', definition: 'Showing a desire to resist authority.' },
      { word: 'compassion', definition: 'Sympathetic concern for the suffering or difficulty of others.' },
    ],
    hotspots: [
      { id: 'h13a', x: 47, y: 50, title: 'Habil’s Restraint', description: "Habil did not fear his brother's threats, but he also did not want his brother to be hurt." },
      { id: 'h13b', x: 78, y: 40, title: 'Compassion', description: 'Allah gave Habil purity and compassion.' },
    ],
    animatedWords: ['aggressive', 'rebellious', 'compassion'],
  },
  {
    id: 14,
    type: 'story',
