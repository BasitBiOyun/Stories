...
export const adamB2StoryPagesPart2a: PageData[] = [
  {
    id: 10,
    type: 'story',
    ...
    exercises: [{ id: 'qc-10', type: 'multiple-choice', title: 'Quick Challenge', instructions: 'Choose the correct answer.', question: 'What was the purpose of Adam (pbuh) and Eve\'s experience on Earth?', options: ['To punish them', 'To teach them that Satan is their enemy and their testing as vicegerent', 'To make them forget Allah'], correctAnswer: 1, feedback: { correct: 'Correct!', incorrect: 'Try again.' } }]
  },
  {
    id: 11,
    type: 'story',
    ...
    exercises: [{ id: 'qc-11', type: 'multiple-choice', title: 'Quick Challenge', instructions: 'Choose the correct answer.', question: 'What eased Adam (pbuh)\'s grief on Earth?', options: ['He was master of the Earth', 'He had infinite food', 'He was back in Paradise'], correctAnswer: 0, feedback: { correct: 'Correct!', incorrect: 'Try again.' } }]
  },
  {
    id: 12,
    type: 'story',
    ...
    exercises: [{ id: 'qc-12', type: 'multiple-choice', title: 'Quick Challenge', instructions: 'Choose the correct answer.', question: 'Why was Qabil\'s sacrifice not accepted?', options: ['He offered his best', 'He was insincere', 'He was too young'], correctAnswer: 1, feedback: { correct: 'Correct!', incorrect: 'Try again.' } }]
  },
  {
    id: 13,
    type: 'story',
    ...
    exercises: [{ id: 'qc-13', type: 'multiple-choice', title: 'Quick Challenge', instructions: 'Choose the correct answer.', question: 'How did Habil respond to Qabil\'s threat?', options: ['He fought back', 'He chose peace advised his brother to do a good deed and left the matter to Allah', 'He ran away'], correctAnswer: 1, feedback: { correct: 'Correct!', incorrect: 'Try again.' } }]
  }
];