...
export const adamB1PolishedQuickChallengesAr: Record<number, Exercise> = {
  ...
  2: {
    ...
    matchingPairs: [
      ...
      { left: 'العلم الواسع', right: 'الخير في الأرض' },
    ],
    correctAnswer: {
      'تراب من أماكن مختلفة': 'اختلاف ألوان بشرة البشر',
      'الحياة والعقل': 'التعلم والفهم',
      'العلم الواسع': 'الخير في الأرض',
    },
    explanation: 'يربط الفصل تنوع التراب بتنوع البشر، والعقل بالتعلم والفهم، والعلم بالخير في الأرض.',
  },
};
