  ...
  6: [
    ...
    },
    {
      ...
      matchingPairs: [
        ...
        { left: 'he felt his heart filled with pain, sadness and shame', right: 'describes an emotional state after the action' },
      ...
      correctAnswer: {
        ...
        'he felt his heart filled with pain, sadness and shame': 'describes an emotional state after the action',
      ...
      explanation: 'The paragraph combines coordinated past actions with a “when” time clause, a feeling expression, resulting changes, and “discover that + clause” to move the narrative forward coherently.',
      feedback: {
    ...
    },
    {
      ...
      matchingPairs: [
        ...
        { left: 'because sense of shame is inborn human nature', right: 'gives a reason for the reaction described' },
      ...
      correctAnswer: {
        ...
        'because sense of shame is inborn human nature': 'gives a reason for the reaction described',
