...
export const adamB1Pages: PageData[] = [
  ...
  { id: 15, type: 'vocabulary-match', title: 'B1 Vocabulary Challenge', content: 'Match ten meaning-bearing Word Notes from across the story with their correct meanings.' },
  {
    ...
    vocabulary: [
      { word: 'Messenger', definition: 'A person chosen to convey divine guidance.' },
      { word: 'ruler', definition: 'A steward or khalifa entrusted with responsibility on earth.' },
      { word: 'curiosity', definition: 'A strong desire to know or understand.' },
      { word: 'intellect', definition: 'The ability to reason, learn, and understand.' },
      { word: 'knowledge', definition: 'Understanding or information gained or given.' },
      { word: 'diversity', definition: 'The condition of having different forms or characteristics.' },
      { word: 'arrogant', definition: 'Having an exaggerated sense of one’s own importance.' },
      ...
      { word: 'expulsion', definition: 'The act of forcing someone to leave.' },
      { word: 'enemy', definition: 'Someone actively opposed or hostile.' },
      { word: 'companionship', definition: 'The state of sharing life or time with another person.' },
      { word: 'deception', definition: 'Making someone believe something that is not true.' },
  ...
  },
  {
    ...
    vocabulary: [
      { word: 'repentance', definition: 'Sincere regret followed by turning back from a wrong action.' },
      { word: 'pardon', definition: 'Forgiveness for an offense or error.' },
      { word: 'barrier', definition: 'Something that prevents progress or clear understanding.' },
      { word: 'struggle', definition: 'Make a strong effort during difficulty.' },
      { word: 'survive', definition: 'Continue to live despite difficulty or danger.' },
      { word: 'shelter', definition: 'A place that gives protection.' },
      { word: 'righteously', definition: 'In a morally right way.' },
      { word: 'sacred', definition: 'Considered holy and deserving respect.' },
      { word: 'purpose', definition: 'The reason for which something exists or is done.' },
      ...
      { word: 'sincerity', definition: 'Honest intention without pretense.' },
      { word: 'panic', definition: 'Sudden strong fear or anxiety.' },
      { word: 'raven', definition: 'A large black bird.' },
      { word: 'regret', definition: 'Sadness about a past action.' },
      { word: 'legacy', definition: 'Something influential passed to later generations.' },
      { word: 'admitting', definition: 'Accepting or saying that something is true.' },
      { word: 'worldwide', definition: 'Across the world.' },
    ],
  },
