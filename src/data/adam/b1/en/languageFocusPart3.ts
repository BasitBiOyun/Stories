...
export const adamB1LanguageFocusExercisesPart3: Record<number, Exercise[]> = {
  4: [
    ...
    },
    {
      ...
      matchingPairs: [
        { left: 'He didn’t want Allah to be kind to Adam (pbuh).', right: 'expresses a desired or undesired outcome involving another person' },
        { left: 'because of Adam (pbuh)', right: 'gives a reason with a noun phrase rather than a full clause' },
        { left: 'He thought that because of Adam (pbuh), Allah had put him far from His help.', right: 'reports the belief through which the character interprets the event' },
      ],
      correctAnswer: {
        'He didn’t want Allah to be kind to Adam (pbuh).': 'expresses a desired or undesired outcome involving another person',
        'because of Adam (pbuh)': 'gives a reason with a noun phrase rather than a full clause',
        'He thought that because of Adam (pbuh), Allah had put him far from His help.': 'reports the belief through which the character interprets the event',
      },
      explanation: '“Want + object + to ...” expresses a desired outcome involving someone else. “Because of + noun” gives a reason without adding a full clause, while “thought that ...” keeps the interpretation inside the character’s viewpoint.',
      feedback: {
    ...
    },
    {
      ...
      matchingPairs: [
        { left: 'waited for a chance to keep Adam (pbuh) away', right: 'shows purpose after waiting for an opportunity' },
        { left: 'keep Adam (pbuh) away from Allah’s kindness', right: 'describes preventing someone from staying close to something' },
        { left: 'just like himself', right: 'compares one intended situation with another person’s situation' },
        { left: 'warned him to be careful of Iblis', right: 'reports a warning directed to another person' },
      ],
      correctAnswer: {
        'waited for a chance to keep Adam (pbuh) away': 'shows purpose after waiting for an opportunity',
        'keep Adam (pbuh) away from Allah’s kindness': 'describes preventing someone from staying close to something',
        'just like himself': 'compares one intended situation with another person’s situation',
        'warned him to be careful of Iblis': 'reports a warning directed to another person',
      },
      explanation: 'The chapter uses “a chance to ...” for opportunity and purpose, “keep + object + away from ...” for prevention, “just like ...” for similarity, and “warn + object + to be careful of ...” for a reported warning.',
      feedback: {
    ...
    },
    {
      ...
      correctAnswer: null,
      explanation: 'A strong response may use “continued + -ing”, “because of + noun”, “waited for a chance to ...”, “keep + object + away from ...”, and “warned + person + to be careful of ...”.',
      feedback: {
      ...
      discussionPrompts: [
        ...
        { question: 'Sentence 4 — Report a warning with “warned + person + to be careful of ...”.', mode: 'Pair' },
      ],
    },
  ],
};
