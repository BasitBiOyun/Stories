...
export const adamA2PagesAr: PageData[] = [
  ...
  },
  {
    ...
    hotspots: [
      { id: 'h3-1', x: 25, y: 45, title: 'النَّار', description: 'ظَنَّ إِبْلِيسُ أَنَّ النَّارَ أَفْضَلُ مِنَ التُّرَابِ.' },
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: 'h7-2', x: 60, y: 30, title: 'أَوْلاد', description: 'وَرُزِقا أَوْلادًا كَثيرينَ.' }
    ],
    exercises: [
      {
        id: 'p7-ex1',
