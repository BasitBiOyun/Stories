...
export const adamA2PagesAr: PageData[] = [
  ...
  },
  {
    ...
    vocabulary: [
      ...
      { word: 'تراب', definition: 'الأرض التي تنمو فيها النباتات.' },
      { word: 'فضول', definition: 'الرغبة في معرفة شيء أو تعلمه.' },
      { word: 'احترام', definition: 'معاملة شخص بتقدير واهتمام.' },
      { word: 'أحكم', definition: 'يعرف أكثر ويتخذ قرارات أفضل.' },
      { word: 'حسود', definition: 'يحزن لأن غيره يملك شيئا يريده.' },
      { word: 'متكبر', definition: 'يظن أنه أفضل أو أهم من الآخرين.' },
      { word: 'قيم', definition: 'مفيد أو مهم جدا.' },
      { word: 'مخلوق', definition: 'كائن حي خلقه الله.' },
      { word: 'وحيد', definition: 'حزين لأنه وحده.' },
      { word: 'رائع', definition: 'جميل جدا ومفرح.' },
      { word: 'تحذير', definition: 'تنبيه إلى خطر أو شيء يجب تجنبه.' }
    ]
  },
  {
    id: 15,
    ...
    image: 'https://firebasestorage.googleapis.com/v0/b/gen-lang-client-0373200489.firebasestorage.app/o/Adam_A2%2Fimages%2Fadam-a2_adam_a2_chapter10.png?alt=media&token=1547f902-5af2-4d83-94a6-7d0b70ca0723',
    vocabulary: [
      { word: 'عدم الأمانة', definition: 'عدم قول الحقيقة.' },
      { word: 'ندم', definition: 'الشعور بالأسف على خطأ.' },
      { word: 'متفوق', definition: 'أفضل أو أعلى من غيره.' },
      { word: 'محاصيل', definition: 'نباتات تُزرع للغذاء.' },
      { word: 'حكم', definition: 'قيادة مكان وتنظيم شؤونه.' },
      { word: 'كوكب', definition: 'عالم كبير في الفضاء مثل الأرض.' },
      { word: 'صادق', definition: 'يقول الحقيقة ولا يخدع.' },
      { word: 'يتصرف', definition: 'يتعامل أو يعمل بطريقة معينة.' },
      { word: 'عدو', definition: 'شخص يريد الضرر أو يعارض شخصا آخر.' },
      { word: 'راعي', definition: 'شخص يعتني بالغنم.' },
      { word: 'مزارع', definition: 'شخص يزرع المحاصيل أو يعتني بالحيوانات في مزرعة.' },
