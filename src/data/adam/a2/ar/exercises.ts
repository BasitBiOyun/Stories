...
{
    id: 'adam-a2-ar-final-1', type: 'multiple-choice', title: 'الأرض والعمل', instructions: 'اختر الجملة الصحيحة.',
    question: 'ماذا يقول الفصلان الأول والسادس عن حياة الناس في الأرض؟',
    options: ['يقول الفصل الأول إن على الناس الابتعاد عن الأرض، ويقول الفصل السادس إنهم يعودون فورًا إلى الجنة.','يقول الفصل الأول إن للناس دورًا في الأرض، ويعرض الفصل السادس بعض أعمالهم فيها.','يقول الفصل الأول إن الناس بلا دور في الأرض، ويقول الفصل السادس إنهم بلا واجبات.'], correctAnswer: 1,
  ...
  },
{
    ...
    question: 'ماذا أراد إبليس أن يحدث لآدم؟', options: ['أراد أن يبقى آدم حذرا من إبليس','أراد أن يواصل آدم اتباع تحذير الله','أراد أن يفقد آدم محبة الله'], correctAnswer: 2,
...
{
    id: 'adam-a2-ar-final-6', type: 'matching', title: 'هابيل وقابيل', instructions: 'صل كل أخ بالوصف الصحيح.',
    question: 'ما الوصف الصحيح لكل أخ؟',
    matchingPairs: [
      { left: 'هابيل', right: 'لطيف وهادئ واختار ألا يؤذي أخاه' },
      { left: 'قابيل', right: 'كان حسودًا وأدى غضبه إلى أمر سيئ جدًا' }
    ],
    correctAnswer: { 'هابيل': 'لطيف وهادئ واختار ألا يؤذي أخاه', 'قابيل': 'كان حسودًا وأدى غضبه إلى أمر سيئ جدًا' },
...
{
    id: 'adam-a2-ar-final-10', type: 'sequencing', title: 'ترتيب القصة', instructions: 'رتب هذه الأحداث بالترتيب الصحيح.',
    question: 'ماذا حدث أولًا ثم بعد ذلك؟',
    sequencingItems: [
      { id: '1', text: 'يكذب إبليس بشأن الشجرة' },
      { id: '2', text: 'يقع آدم وحواء في الخطأ ويطلبان المغفرة' },
      { id: '3', text: 'يبدآن الحياة على الأرض ويعملان فيها' },
      { id: '4', text: 'يقدم هابيل وقابيل قربانين مختلفين' },
      { id: '5', text: 'يُظهر الغراب لقابيل ما يفعل بعد موت هابيل' }
    ],
    correctAnswer: ['1', '2', '3', '4', '5'],
    explanation: 'تحدث هذه الأحداث بهذا الترتيب في الفصول 5–9.', feedback: { correct: 'صحيح. ربطت خمس مراحل بالترتيب.', incorrect: 'استخدم الفصول 5–9 وضع حدثا واحدا في كل مرة.' }
  },
{
    ...
    options: ['لأنه خُلق من النار','لأن الله أعطاه العلم وعلّمه أن يفكر ويتعلم','لأن لديه أبناء كثيرين'], correctAnswer: 1,
