...
export const adamA2FinalChallengeExercisesAr: Exercise[] = [
  {
    ...
    options: [
      'يقول الفصل الأول إن للناس دورًا في الأرض، ويعرض الفصل السادس بعض أعمالهم فيها.',
      'يقول الفصل الأول إن على الناس الابتعاد عن الأرض، ويقول الفصل السادس إنهم يعودون فورًا إلى الجنة.',
      'يقول الفصل الأول إن الناس بلا دور في الأرض، ويقول الفصل السادس إنهم بلا واجبات.'
    ], correctAnswer: 0,
