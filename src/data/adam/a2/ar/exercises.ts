...
export const adamA2FinalReviewExercisesAr: Exercise[] = [
  ...
  {
    id: 'adam-a2-ar-review-2', type: 'matching', title: 'الدليل والدرس', instructions: 'صل كل تفصيل من القصة بالفكرة التي يساعد على إظهارها.', question: 'ما الفكرة الأوسع التي يدعمها كل تفصيل؟',
    matchingPairs: [
      { left: 'جاء التراب من أماكن مختلفة من الأرض', right: 'التنوع البشري' },
      { left: 'قرر آدم وحواء ألا يكررا خطأهما', right: 'التعلم والإصلاح' },
      { left: 'قدم هابيل أفضل ما عنده', right: 'بذل أفضل ما نستطيع' },
      { left: 'يبتعد الناس عن الحسد ويسيطرون على الغضب', right: 'ضبط النفس' }
    ],
    correctAnswer: {
      'جاء التراب من أماكن مختلفة من الأرض': 'التنوع البشري',
      'قرر آدم وحواء ألا يكررا خطأهما': 'التعلم والإصلاح',
      'قدم هابيل أفضل ما عنده': 'بذل أفضل ما نستطيع',
      'يبتعد الناس عن الحسد ويسيطرون على الغضب': 'ضبط النفس'
    },
    explanation: 'يربط المتعلم هنا بين الدليل ومعناه الأوسع بدلا من مجرد تذكر من فعل ماذا.',
    feedback: { correct: 'صحيح. ربطت دليل القصة بمعناه.', incorrect: 'اقرأ كل تفصيل أولا ثم اسأل: ما الدرس الذي يربطه الفصل بهذا التفصيل؟' }
  },
  {
