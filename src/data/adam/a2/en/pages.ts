    ...
    vocabulary: [
      {
        ...
        wordFamily: ['message', 'messenger'],
        collocations: ['messenger of Allah', 'carry a message'],
        chapter: 1,
        chapterTitle: 'Opening & The Creation',
        storyExample: 'Adam (pbuh) is the first messenger of Allah and the father of all humans.',
        category: 'Spiritual Life',
      },
      {
        word: 'soil',
        definition: 'Earth in which plants can grow.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/sɔɪl/',
        collocations: ['from soil', 'soil from different lands'],
        synonyms: ['earth'],
        chapter: 1,
        chapterTitle: 'Opening & The Creation',
        storyExample: 'Allah created him from soil and cared about him very much because he was the first human.',
      ...
      },
      {
        ...
        wordFamily: ['curious', 'curiosity', 'curiously'],
        collocations: ['with curiosity', 'natural curiosity'],
        synonyms: ['interest'],
        chapter: 1,
        chapterTitle: 'Opening & The Creation',
        storyExample: 'They began waiting with curiosity.',
        category: 'Learning & Thinking',
      },
      {
        word: 'grandchildren',
        definition: 'The children of a person’s children.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈɡrænˌtʃɪldrən/',
        wordFamily: ['grandchild', 'grandchildren', 'grandparent'],
        collocations: ['children and grandchildren', 'grandchildren of Adam'],
        chapter: 1,
        chapterTitle: 'Opening & The Creation',
        storyExample: 'We are the grandchildren of Adam (pbuh), so we can learn many lessons from this fantastic story.',
        category: 'Family',
      },
      {
        word: 'respect',
        definition: 'Treating someone as important and worthy of care.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/rɪˈspekt/',
        wordFamily: ['respect', 'respectful', 'respectfully'],
        collocations: ['show respect', 'respect someone'],
        synonyms: ['regard'],
        antonyms: ['disrespect'],
        chapter: 2,
        chapterTitle: 'Knowledge and Respect',
        storyExample: 'After I have created Adam and given him life, show respect to him.',
        category: 'Values',
      },
      {
        word: 'knowledge',
        definition: 'Things a person knows and understands.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈnɑːlɪdʒ/',
        wordFamily: ['know', 'knowledge', 'knowledgeable'],
        collocations: ['gain knowledge', 'useful knowledge'],
        synonyms: ['understanding'],
        antonyms: ['ignorance'],
        chapter: 2,
        chapterTitle: 'Knowledge and Respect',
        storyExample: 'He was wiser than the angels, because Allah gave Adam knowledge and taught him to think.',
        category: 'Learning & Thinking',
      },
      {
        word: 'admired',
        definition: 'Liked and respected someone very much.',
        partOfSpeech: 'verb',
        level: 'A2',
        pronunciation: '/ədˈmaɪərd/',
        wordFamily: ['admire', 'admired', 'admiration'],
        collocations: ['admire someone', 'admired and respected'],
        synonyms: ['respected'],
        chapter: 2,
        chapterTitle: 'Knowledge and Respect',
        storyExample: 'They all admired him and respected him.',
        category: 'Feelings & Attitudes',
      },
      {
        word: 'clay',
        definition: 'Soft earth that can be shaped.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/kleɪ/',
        collocations: ['created from clay', 'soft clay'],
        chapter: 2,
        chapterTitle: 'Knowledge and Respect',
        storyExample: 'Iblis thought Adam was an unimportant creature created from clay.',
        category: 'World & Nature',
      },
      {
        word: 'arrogant',
        definition: 'Thinking you are better or more important than others.',
        partOfSpeech: 'adjective',
        level: 'A2',
        pronunciation: '/ˈærəɡənt/',
        wordFamily: ['arrogant', 'arrogance', 'arrogantly'],
        collocations: ['arrogant person', 'become arrogant'],
        synonyms: ['proud'],
        antonyms: ['humble'],
        chapter: 3,
      ...
      },
      {
        ...
        wordFamily: ['value', 'valuable'],
        collocations: ['valuable knowledge', 'valuable gift'],
        synonyms: ['important', 'useful'],
        antonyms: ['worthless'],
        chapter: 3,
        chapterTitle: "Iblis's Arrogance",
        storyExample: 'He thought he was more important and more valuable than Adam.',
        category: 'Description',
      },
      {
        word: 'creature',
        definition: 'A living being created by Allah.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈkriːtʃər/',
        wordFamily: ['create', 'creation', 'creature'],
        collocations: ['living creature', 'creature of Allah'],
        synonyms: ['living being'],
        chapter: 3,
        chapterTitle: "Iblis's Arrogance",
        storyExample: 'It was for the good of every creature of Allah.',
        category: 'World & Nature',
      },
      {
        word: 'origin',
        definition: 'The place or material something comes from.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈɔːrɪdʒɪn/',
        wordFamily: ['origin', 'original', 'originate'],
        collocations: ['place of origin', 'human origin'],
        synonyms: ['source', 'beginning'],
        chapter: 3,
        chapterTitle: "Iblis's Arrogance",
        storyExample: 'He came from the fire and believed his origin was better.',
      ...
      },
      {
        ...
        wordFamily: ['lonely', 'loneliness'],
        collocations: ['feel lonely', 'be lonely'],
        synonyms: ['alone'],
        chapter: 4,
        chapterTitle: 'Paradise and the Warning',
        storyExample: 'Then, Adam started to feel lonely in Paradise.',
        category: 'Feelings',
      },
      {
        word: 'wonderful',
        ...
        wordFamily: ['wonder', 'wonderful'],
        collocations: ['wonderful place', 'wonderful life'],
        synonyms: ['excellent', 'great'],
        antonyms: ['terrible'],
        chapter: 4,
        chapterTitle: 'Paradise and the Warning',
        storyExample: 'It was more wonderful than we can imagine.',
        category: 'Description',
      },
      {
        word: 'warning',
        definition: 'A message about danger or something to avoid.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈwɔːrnɪŋ/',
        wordFamily: ['warn', 'warning'],
        collocations: ['give a warning', 'remember a warning'],
        synonyms: ['alert', 'caution'],
        chapter: 4,
        chapterTitle: 'Paradise and the Warning',
        storyExample: 'But Allah had only one warning.',
      ...
      },
      {
        ...
        level: 'A2',
        pronunciation: '/waɪf/',
        wordFamily: ['wife', 'wives'],
        collocations: ['husband and wife', 'his wife'],
        chapter: 4,
        chapterTitle: 'Paradise and the Warning',
        storyExample: 'So, Allah gave him a wife.',
        category: 'Family',
      },
      {
        word: 'lie',
        ...
        level: 'A2',
        pronunciation: '/laɪ/',
        wordFamily: ['lie', 'lied', 'lying', 'liar'],
        collocations: ['tell a lie', 'believe a lie'],
        synonyms: ['falsehood'],
        antonyms: ['truth'],
        chapter: 5,
        chapterTitle: "Satan's Lie and Regret",
        storyExample: 'It was a big lie.',
        category: 'Truth & Choices',
      },
      {
        word: 'mistake',
        definition: 'Something you do that is wrong.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/mɪˈsteɪk/',
        wordFamily: ['mistake', 'mistaken'],
        collocations: ['make a mistake', 'learn from a mistake'],
        synonyms: ['error'],
        chapter: 5,
        chapterTitle: "Satan's Lie and Regret",
      ...
      {
        word: 'forgetful',
        definition: 'Often forgetting things.',
        partOfSpeech: 'adjective',
        level: 'A2',
        pronunciation: '/fərˈɡetfəl/',
        wordFamily: ['forget', 'forgot', 'forgotten', 'forgetful'],
        collocations: ['forgetful person', 'become forgetful'],
        chapter: 5,
        chapterTitle: "Satan's Lie and Regret",
        storyExample: 'Unfortunately, people are sometimes forgetful.',
        category: 'Personal Traits',
      },
      {
        word: 'superior',
        definition: 'Better or higher than someone or something.',
        partOfSpeech: 'adjective',
        level: 'A2',
        pronunciation: '/suːˈpɪriər/',
        wordFamily: ['superior', 'superiority'],
        collocations: ['superior to', 'feel superior'],
        synonyms: ['better', 'higher'],
        antonyms: ['inferior'],
        chapter: 5,
        chapterTitle: "Satan's Lie and Regret",
        storyExample: 'He believed that he was superior to, smarter than and more important than the human.',
        category: 'Comparison & Attitudes',
      },
      {
        word: 'crops',
        ...
        wordFamily: ['crop', 'crops'],
        collocations: ['grow crops', 'farm crops'],
        chapter: 6,
        chapterTitle: 'Life on Earth',
        storyExample: 'They were using land to grow crops and keep animals.',
        category: 'Work & Nature',
      },
      {
        word: 'rule',
        definition: 'To lead or manage a place.',
        partOfSpeech: 'verb',
        level: 'A2',
        pronunciation: '/ruːl/',
        wordFamily: ['rule', 'ruler', 'ruling'],
        collocations: ['rule the earth', 'rule a place'],
        synonyms: ['govern', 'manage'],
        chapter: 6,
        chapterTitle: 'Life on Earth',
        storyExample: 'Allah taught them and gave them everything to rule on earth.',
        category: 'Leadership & Responsibility',
      },
      {
        word: 'planet',
        definition: 'A large round object in space, such as Earth.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈplænɪt/',
        wordFamily: ['planet', 'planetary'],
        collocations: ['planet Earth', 'live on a planet'],
        chapter: 6,
        chapterTitle: 'Life on Earth',
        storyExample: 'They were the rulers of the planet Earth.',
        category: 'World & Nature',
      },
      {
        word: 'weak',
        definition: 'Not strong or needing help.',
        partOfSpeech: 'adjective',
        level: 'A2',
        pronunciation: '/wiːk/',
        wordFamily: ['weak', 'weakness', 'weaken'],
        collocations: ['help the weak', 'weak person'],
        synonyms: ['frail'],
        antonyms: ['strong'],
        chapter: 6,
        chapterTitle: 'Life on Earth',
        storyExample: 'They were going to build buildings for housing, protect nature and help the weak.',
      ...
      },
      {
        ...
        collocations: ['honest person', 'honest life'],
        synonyms: ['truthful'],
        antonyms: ['dishonest'],
        chapter: 7,
        chapterTitle: 'The First Messenger',
        storyExample: 'He started teaching people to be honest, do good, stop bad and always remember Allah.',
        category: 'Values',
      },
      {
        word: 'behave',
        ...
        wordFamily: ['behave', 'behavior', 'well-behaved'],
        collocations: ['behave well', 'behave badly'],
        synonyms: ['act'],
        chapter: 7,
        chapterTitle: 'The First Messenger',
        storyExample: 'Adam (pbuh) and Eve taught their children to behave well for the love of Allah.',
        category: 'Actions & Conduct',
      },
      {
        word: 'enemy',
        definition: 'A person who wants to harm or oppose someone.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈenəmi/',
        wordFamily: ['enemy', 'enemies'],
        collocations: ['be an enemy', 'enemy, not a friend'],
        synonyms: ['opponent'],
        antonyms: ['friend'],
        chapter: 7,
        chapterTitle: 'The First Messenger',
        storyExample: 'Iblis was their enemy, not their friend.',
        category: 'Relationships',
      },
      {
        word: 'messengers',
        definition: 'People sent by Allah with His message.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈmesɪndʒərz/',
        wordFamily: ['message', 'messenger', 'messengers'],
        collocations: ['messengers of Allah', 'send messengers'],
        chapter: 7,
        chapterTitle: 'The First Messenger',
        storyExample: 'After the death of Adam (pbuh), Allah sent many other messengers.',
        category: 'Spiritual Life',
      },
      {
        word: 'shepherd',
        definition: 'A person who looks after sheep.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈʃepərd/',
        wordFamily: ['shepherd', 'shepherds'],
        collocations: ['become a shepherd', 'work as a shepherd'],
        chapter: 8,
        chapterTitle: 'Story of Habil and Qabil',
        storyExample: 'When they grew up, Habil became a shepherd.',
        category: 'People & Roles',
      },
      {
        word: 'farmer',
        definition: 'A person who grows crops or keeps animals on a farm.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈfɑːrmər/',
        wordFamily: ['farm', 'farmer', 'farming'],
        collocations: ['become a farmer', 'work as a farmer'],
        chapter: 8,
        chapterTitle: 'Story of Habil and Qabil',
        storyExample: 'Qabil was a farmer.',
        category: 'People & Roles',
      },
      {
        word: 'offering',
        definition: 'Something given to Allah.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈɔːfərɪŋ/',
        wordFamily: ['offer', 'offered', 'offering'],
        collocations: ['make an offering', 'accept an offering'],
        synonyms: ['gift'],
        chapter: 8,
        chapterTitle: 'Story of Habil and Qabil',
        storyExample: 'To solve the problem, they had to offer an offering to Allah.',
        category: 'Spiritual Life',
      },
      {
        word: 'jealous',
        ...
        wordFamily: ['jealous', 'jealousy'],
        collocations: ['feel jealous', 'jealous of someone'],
        synonyms: ['envious'],
        chapter: 8,
        chapterTitle: 'Story of Habil and Qabil',
      ...
      },
      {
        ...
        level: 'A2',
        pronunciation: '/kroʊ/',
        wordFamily: ['crow', 'crows'],
        collocations: ['black crow', 'send a crow'],
        chapter: 9,
        chapterTitle: 'The First Crime',
        storyExample: 'Then, Allah sent a crow.',
      ...
      },
      {
        ...
        wordFamily: ['panic', 'panicked', 'panicking'],
        collocations: ['start to panic', 'panic suddenly'],
        synonyms: ['fear', 'alarm'],
        antonyms: ['calm'],
        chapter: 9,
        chapterTitle: 'The First Crime',
        storyExample: 'But he also started to panic.',
        category: 'Feelings',
      },
      {
        word: 'digging',
        definition: 'Making a hole by moving earth.',
        partOfSpeech: 'verb',
        level: 'A2',
        pronunciation: '/ˈdɪɡɪŋ/',
        wordFamily: ['dig', 'dug', 'digging'],
        collocations: ['digging the ground', 'start digging'],
        chapter: 9,
        chapterTitle: 'The First Crime',
        storyExample: 'It landed on the ground near Qabil and started digging the ground.',
        category: 'Actions',
      },
      {
        word: 'harm',
        definition: 'To hurt someone or cause damage.',
        partOfSpeech: 'verb',
        level: 'A2',
        pronunciation: '/hɑːrm/',
        wordFamily: ['harm', 'harmful', 'harmless'],
        collocations: ['harm someone', 'cause harm'],
        synonyms: ['hurt', 'damage'],
        antonyms: ['protect'],
        chapter: 9,
        chapterTitle: 'The First Crime',
        storyExample: 'I won’t fight back or harm you.',
        category: 'Actions & Safety',
      },
      {
        word: 'jealousy',
        definition: 'Feeling unhappy because someone has something you want.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈdʒeləsi/',
        wordFamily: ['jealous', 'jealousy'],
        collocations: ['stay away from jealousy', 'feelings of jealousy'],
        synonyms: ['envy'],
        chapter: 10,
        chapterTitle: 'The Story of Adam (pbuh)',
        storyExample: 'The story tells us that good people should stay away from jealousy and control their anger.',
        category: 'Feelings',
      },
      {
        word: 'story',
        ...
        wordFamily: ['story', 'stories'],
        collocations: ['tell a story', 'story teaches us'],
        synonyms: ['tale'],
        chapter: 10,
        chapterTitle: 'The Story of Adam (pbuh)',
        storyExample: 'The story tells us that good people should stay away from jealousy and control their anger.',
      ...
      {
        word: 'worldwide',
        definition: 'In many places around the world.',
        partOfSpeech: 'adverb',
        level: 'A2',
        pronunciation: '/ˌwɜːrldˈwaɪd/',
        wordFamily: ['world', 'worldwide'],
        collocations: ['spread worldwide', 'known worldwide'],
        synonyms: ['globally'],
        chapter: 10,
        chapterTitle: 'The Story of Adam (pbuh)',
        storyExample: 'His children and grandchildren spread his message worldwide.',
        category: 'Place & Scope',
      },
      {
        word: 'message',
        definition: 'An important idea that is shared with others.',
        partOfSpeech: 'noun',
        level: 'A2',
        pronunciation: '/ˈmesɪdʒ/',
        wordFamily: ['message', 'messenger'],
        collocations: ['spread a message', 'important message'],
        chapter: 10,
        chapterTitle: 'The Story of Adam (pbuh)',
        storyExample: 'This message still advises people to love and respect Allah.',
