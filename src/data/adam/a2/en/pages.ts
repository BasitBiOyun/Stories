...
export const adamA2Pages: PageData[] = [
  {
    ...
    vocabulary: [
      ...
      { word: 'grandchildren', definition: 'The children of a person’s children.' },
    ],
    hotspots: [
      { id: 'adam-a2-en-h1a', x: 30, y: 40, title: 'Soil', description: 'Allah created Adam from soil.' },
      { id: 'adam-a2-en-h1b', x: 70, y: 20, title: 'Earth', description: 'Allah created the sky and the earth.' },
    ],
  ...
  },
  {
    ...
    vocabulary: [
      ...
      { word: 'knowledge', definition: 'Things a person knows and understands.' },
      { word: 'admired', definition: 'Liked and respected someone very much.' },
      { word: 'clay', definition: 'Soft earth that can be shaped.' },
    ],
    hotspots: [
      { id: 'adam-a2-en-h2a', x: 40, y: 30, title: 'Knowledge', description: 'Allah gave Adam knowledge and taught him to think.' },
      { id: 'adam-a2-en-h2b', x: 60, y: 50, title: 'Angels', description: 'The angels admired and respected Adam.' },
    ],
  },
  {
    ...
    vocabulary: [
      ...
      { word: 'origin', definition: 'The place or material something comes from.' },
    ],
    hotspots: [
      { id: 'adam-a2-en-h3a', x: 25, y: 45, title: 'Fire and Soil', description: 'Iblis compared fire with the soil from which Adam was created.' },
      { id: 'adam-a2-en-h3b', x: 75, y: 35, title: 'Arrogance', description: 'Iblis thought he was better than Adam.' },
    ],
  },
  {
    ...
    hotspots: [
      { id: 'adam-a2-en-h4a', x: 35, y: 40, title: 'Eve (Hawwa)', description: 'Allah gave Adam a wife named Eve.' },
      { id: 'adam-a2-en-h4b', x: 65, y: 25, title: 'The Tree', description: 'Allah warned Adam and Eve not to go near one tree.' },
    ],
  },
  {
    ...
    hotspots: [
      { id: 'adam-a2-en-h5a', x: 45, y: 35, title: 'The Lie', description: 'Iblis told Adam and Eve a lie about the tree.' },
      { id: 'adam-a2-en-h5b', x: 55, y: 60, title: 'The Mistake', description: 'Adam and Eve made a mistake and asked Allah to forgive them.' },
    ],
  },
  {
    ...
    hotspots: [
      { id: 'adam-a2-en-h6a', x: 30, y: 50, title: 'Earth', description: 'Adam and Eve began their life on earth.' },
      { id: 'adam-a2-en-h6b', x: 70, y: 40, title: 'Work', description: 'They grew crops, kept animals, and helped the weak.' },
    ],
  },
  {
    ...
    vocabulary: [
      ...
      { word: 'messengers', definition: 'People sent by Allah with His message.' },
    ],
    hotspots: [
      { id: 'adam-a2-en-h7a', x: 40, y: 45, title: 'Messenger', description: 'Allah made Adam His first Messenger.' },
      { id: 'adam-a2-en-h7b', x: 60, y: 30, title: 'Teaching', description: 'Adam and Eve taught their children to behave well and remember Allah.' },
    ],
  },
  {
    ...
    vocabulary: [
      ...
      { word: 'jealous', definition: 'Unhappy because someone has something you want.' },
    ],
    hotspots: [
      { id: 'adam-a2-en-h8a', x: 35, y: 55, title: 'Habil', description: 'Habil cared for animals and brought his best sheep.' },
      { id: 'adam-a2-en-h8b', x: 65, y: 45, title: 'Qabil', description: 'Qabil farmed the land and brought some of his crops.' },
    ],
  },
  {
    ...
    vocabulary: [
      ...
      { word: 'harm', definition: 'To hurt someone or cause damage.' },
    ],
    hotspots: [
      { id: 'adam-a2-en-h9a', x: 50, y: 20, title: 'The Crow', description: 'The crow showed Qabil how to bury his brother.' },
      { id: 'adam-a2-en-h9b', x: 40, y: 60, title: 'Panic', description: 'Qabil became afraid after his brother died.' },
    ],
  },
  {
    ...
    vocabulary: [
      ...
      { word: 'message', definition: 'An important idea that is shared with others.' },
    ],
    hotspots: [
      { id: 'adam-a2-en-h10a', x: 45, y: 40, title: 'Adam’s Family', description: 'Adam continued his life with his other children.' },
  ...
  {
    id: 14, type: 'glossary', title: 'Master Glossary - Part 1', content: 'A complete list of the Word Notes from Chapters 1–5.', image: 'https://firebasestorage.googleapis.com/v0/b/gen-lang-client-0373200489.firebasestorage.app/o/Adam_A2%2Fimages%2Fadam-a2_adam_a2_chapter10.png?alt=media&token=1547f902-5af2-4d83-94a6-7d0b70ca0723',
    vocabulary: [
      { word: 'messenger', definition: 'A person who carries a message from Allah.' }, { word: 'soil', definition: 'Earth in which plants can grow.' }, { word: 'curiosity', definition: 'Wanting to know or learn something.' }, { word: 'grandchildren', definition: 'The children of a person’s children.' },
      { word: 'respect', definition: 'Treating someone as important and worthy of care.' }, { word: 'knowledge', definition: 'Things a person knows and understands.' }, { word: 'admired', definition: 'Liked and respected someone very much.' }, { word: 'clay', definition: 'Soft earth that can be shaped.' },
      { word: 'arrogant', definition: 'Thinking you are better or more important than others.' }, { word: 'valuable', definition: 'Very useful or important.' }, { word: 'creature', definition: 'A living being created by Allah.' }, { word: 'origin', definition: 'The place or material something comes from.' },
      { word: 'lonely', definition: 'Sad because you are alone.' }, { word: 'wonderful', definition: 'Very good and enjoyable.' }, { word: 'warning', definition: 'A message about danger or something to avoid.' }, { word: 'wife', definition: 'A married woman.' },
      { word: 'lie', definition: 'Something that is not true.' }, { word: 'mistake', definition: 'Something you do that is wrong.' }, { word: 'forgetful', definition: 'Often forgetting things.' }, { word: 'superior', definition: 'Better or higher than someone or something.' },
    ],
  },
  {
    id: 15, type: 'glossary', title: 'Master Glossary - Part 2', content: 'A complete list of the Word Notes from Chapters 6–10.', image: 'https://firebasestorage.googleapis.com/v0/b/gen-lang-client-0373200489.firebasestorage.app/o/Adam_A2%2Fimages%2Fadam-a2_adam_a2_chapter10.png?alt=media&token=1547f902-5af2-4d83-94a6-7d0b70ca0723',
    vocabulary: [
      { word: 'crops', definition: 'Plants grown for food.' }, { word: 'rule', definition: 'To lead or manage a place.' }, { word: 'planet', definition: 'A large round object in space, such as Earth.' }, { word: 'weak', definition: 'Not strong or needing help.' },
      { word: 'honest', definition: 'Telling the truth and not cheating.' }, { word: 'behave', definition: 'To act in a particular way.' }, { word: 'enemy', definition: 'A person who wants to harm or oppose someone.' }, { word: 'messengers', definition: 'People sent by Allah with His message.' },
      { word: 'shepherd', definition: 'A person who looks after sheep.' }, { word: 'farmer', definition: 'A person who grows crops or keeps animals on a farm.' }, { word: 'offering', definition: 'Something given to Allah.' }, { word: 'jealous', definition: 'Unhappy because someone has something you want.' },
      { word: 'crow', definition: 'A large black bird.' }, { word: 'panic', definition: 'A sudden strong feeling of fear.' }, { word: 'digging', definition: 'Making a hole by moving earth.' }, { word: 'harm', definition: 'To hurt someone or cause damage.' },
      { word: 'jealousy', definition: 'Feeling unhappy because someone has something you want.' }, { word: 'story', definition: 'A description of events.' }, { word: 'worldwide', definition: 'In many places around the world.' }, { word: 'message', definition: 'An important idea that is shared with others.' },
    ],
  },
  { id: 16, type: 'final-challenge', title: 'Final Challenge', content: 'Show what you learned across the whole story with ten different scored activities.', image: 'https://firebasestorage.googleapis.com/v0/b/gen-lang-client-0373200489.firebasestorage.app/o/Adam_A2%2Fimages%2Fadam-a2_adam_a2_chapter10.png?alt=media&token=1547f902-5af2-4d83-94a6-7d0b70ca0723' },
];