...
كَانَ بَنُو إِسْرَائِيلَ أَكْثَرَ عَدَدًا مِنَ الْمِصْرِيِّينَ. خَافَ فِرْعَوْنُ مِنْ أَنْ يَسْتَوْلُوا عَلَى مَمْلَكَتِهِ. وَبِسَبَبِ خَوْفِهِ، كَانَ فَظًّا مَعَ بَنِي إِسْرَائِيلَ. جَعَلَ حَيَاتَهُمْ صَعْبَةً. وَأَجْبَرَهُمْ عَلَى الْقِيَامِ بِأَعْمَالٍ خَطِرَةٍ دُونَ أَجْرٍ.`,
    ...
    hotspots: [{ id: 'h1-1', x: 30, y: 40, title: 'فرعون', description: 'ملك مصر المستبد الذي ظلم بني إسرائيل.' }, { id: 'h1-2', x: 70, y: 45, title: 'بنو إسرائيل', description: 'أحفاد يعقوب ويوسف عليهما السلام.' }],
...
ثُمَّ قالَ فِرْعَوْنُ لِجُنودِهِ: «اُقْتُلُوا جَمِيعَ أَطْفالِ بَنِي إِسْرائِيلَ الذُّكُورِ». دَخَلَ جُنودُهُ المَنازِلَ، وَفَتَّشُوا الغُرَفَ. وَعِنْدَما وَجَدُوا أَطْفالًا ذُكورًا، قَتَلُوهُمْ. بَكَتْ جَمِيعُ الأُمَّهاتِ وَالْآباءِ وَالأَخَواتِ، لٰكِنَّ الجُنودَ لَمْ يُبْدُوا أَيَّ رَحْمَةٍ. كانُوا قُسَاةً وَعَدِيمِي الرَّحْمَةِ.`,
    ...
    hotspots: [{ id: 'h2-1', x: 35, y: 35, title: 'الرؤيا والنار', description: 'رأى فرعون نارًا قادمة من القدس تحرق بيوت المصريين.' }, { id: 'h2-2', x: 65, y: 50, title: 'الجنود القساة', description: 'نفذ الجنود أمر فرعون وفتشوا البيوت لقتل الرضع.' }],
...
كانَتْ أُمُّ مُوسَى قَلِقَةً جِدًّا، وَأَخْبَرَتِ ابْنَتَها أَنْ تَتْبَعَ التَّابوتَ. كانَتْ أُمُّ مُوسَى حَزينَةً جِدًّا، لٰكِنَّها عَرَفَتْ أَنَّ اللهَ أَرْحَمُ بِطِفْلِها مِنْها. فَاللهُ خَيْرُ الحافِظينَ.`,
    ...
    hotspots: [{ id: 'h3-1', x: 45, y: 50, title: 'التابوت الصغير', description: 'وضعت أم موسى طفلها الرضيع في تابوت خشبي لحمايته.' }, { id: 'h3-2', x: 65, y: 35, title: 'نهر النيل', description: 'وضعت أم موسى التابوت في نهر النيل فحمله الماء.' }],
...
قالَتْ آسيةُ لِخَدَمِها: "اِبْحَثُوا عَنْ مُرْضِعَةٍ لِلطِّفْلِ." رَأَتْ أُخْتُ مُوسَى كُلَّ شَيْءٍ، فَأَسْرَعَتْ إِلَى آسِية، وَقالَتْ: "أَعْرِفُ امْرَأَةً طَيِّبَةً. تَعيشُ فِي الجِوارِ. سَتَكونُ مُرْضِعَةً جَيِّدَةً لِلطِّفْلِ".`,
    ...
    hotspots: [{ id: 'h4-1', x: 35, y: 45, title: 'الملكة آسية', description: 'زوجة فرعون الصالحة التي أحبت الطفل موسى.' }, { id: 'h4-2', x: 70, y: 40, title: 'قصر فرعون', description: 'حيث انتهى التابوت، فربى الله موسى في بيت فرعون.' }],
...
ذَاتَ يَوْمٍ، كَانَ يَمْشِي فِي السُّوقِ. رَأَى رَجُلَيْنِ يَتَخَاصَمَانِ. كَانَ أَحَدُهُمَا مِصْرِيًّا.`,
    ...
    hotspots: [{ id: 'h5-1', x: 35, y: 45, title: 'حضن الأم', description: 'رد الله موسى إلى أمه لتقر عينها ولا تحزن.' }, { id: 'h5-2', x: 65, y: 40, title: 'السوق والمشاجرة', description: 'رأى موسى شجارًا في السوق بين مصري ورجل من قومه.' }],
...
وَبَعْدَ ذٰلِكَ، جَاءَ رَجُلٌ مِنَ الْمَدِينَةِ مُسْرِعًا، وَقَالَ لِمُوسَى: "يَا مُوسَى، إِنَّ جُنُودَ فِرْعَوْنَ يَبْحَثُونَ عَنْكَ. لَقَدْ قَتَلْتَ مِصْرِيًّا، وَالْآنَ يُرِيدُونَ أَنْ يَقْبِضُوا عَلَيْكَ. اُخْرُجْ مِنَ الْمَدِينَةِ، إِنَّهُمْ يُرِيدُونَ أَنْ يَقْتُلُوكَ".`,
    ...
    hotspots: [{ id: 'h6-1', x: 45, y: 40, title: 'الندم والدعاء', description: 'ندم موسى واستغفر ربه لأنه لم يقصد قتل المصري.' }, { id: 'h6-2', x: 70, y: 50, title: 'تحذير الرجل', description: 'جاء رجل ينصح موسى بالخروج لأن جند فرعون يبحثون عنه.' }],
...
سَأَلَ مُوسَى الْفَتَاتَيْنِ: "لِمَاذَا تَجْلِسَانِ بَعِيدًا عَنِ الْبِئْرِ؟"`,
    ...
    hotspots: [{ id: 'h7-1', x: 35, y: 45, title: 'أرض مدين', description: 'أرض خارج حكم فرعون، هرب إليها موسى.' }, { id: 'h7-2', x: 65, y: 55, title: 'بئر مدين', description: 'وجد موسى الرعاة يسقون أغنامهم، وفتاتين تجلسان بعيدًا.' }],
...
قَالَتِ الْفَتَاتَانِ: "سَاعَدَنَا شَابٌّ فِي سَقْيِ غَنَمِنَا. لَمْ نَنْتَظِرْ حَتَّى يَذْهَبَ الرُّعَاةُ الْآخَرُونَ عَنِ الْبِئْرِ".`,
    ...
    hotspots: [{ id: 'h8-1', x: 35, y: 50, title: 'الأختان والوالد', description: 'تقومان برعي الغنم لأن والدهما شيخ كبير لا يقوى على العمل.' }, { id: 'h8-2', x: 65, y: 40, title: 'مروءة موسى', description: 'سقى موسى للفتاتين غنمهما طواعية دون طلب أجر.' }],
...
وَبَدَأَ مُوسَى يُقِيمُ مَعَ الْعَائِلَةِ، وَسَاعَدَهُمْ فِي عَمَلِهِمْ. وَبَعْدَ ذٰلِكَ، تَزَوَّجَ إِحْدَى الْفَتَاتَيْنِ. وَعَاشُوا حَيَاةً سَعِيدَةً. وَبَعْدَ عَشْرِ سَنَوَاتٍ، قَرَّرَ مُوسَى الْعَوْدَةَ إِلَى مِصْرَ.`,
    ...
    hotspots: [{ id: 'h9-1', x: 35, y: 45, title: 'النبي شعيب', description: 'نبي الله في مدين، استضاف موسى وشكره.' }, { id: 'h9-2', x: 65, y: 45, title: 'العمل والزواج', description: 'عمل موسى راعيًا لعشر سنين وتزوج ابنة شعيب.' }],
...
ثُمَّ قَالَ اللهُ لِمُوسَى: "أَلْقِ عَصَاكَ!". فَأَلْقَى مُوسَى عَصَاهُ عَلَى الْأَرْضِ، فَتَحَوَّلَتْ إِلَى ثُعْبَانٍ كَبِيرٍ.`,
    ...
    hotspots: [{ id: 'h10-1', x: 35, y: 35, title: 'النار البعيدة', description: 'أبصر موسى نارًا في ليلة باردة فذهب ليجلب منها دفئًا لأهله.' }, { id: 'h10-2', x: 65, y: 50, title: 'كلام الله', description: 'في الوادي المقدس طوى، كلم الله موسى واختاره نبيًا.' }],
...
أَخَذَ مُوسَى عَلَيْهِ السَّلَامُ أَخَاهُ هَارُونَ عَلَيْهِ السَّلَامُ مَعَهُ، وَذَهَبَ إِلَى الْقَصْرِ لِتَبْلِيغِ رِسَالَةِ اللهِ. كَانَ فِرْعَوْنُ جَالِسًا عَلَى عَرْشِهِ، وَكَانَ مُسَاعِدُوهُ وَجُنُودُهُ وَاقِفِينَ حَوْلَهُ.`,
    ...
    hotspots: [{ id: 'h11-1', x: 40, y: 35, title: 'اليد البيضاء', description: 'أدخل موسى يده في جيبه فخرجت بيضاء تلمع.' }, { id: 'h11-2', x: 65, y: 50, title: 'هارون عليه السلام', description: 'أشرك الله هارون في الرسالة ليكون معينًا لموسى.' }],
...
سَخِرَ فِرْعَوْنُ وَمُسَاعِدُوهُ مِنْ مُوسَى وَرِسَالَتِهِ. وَقَالَ فِرْعَوْنُ لِمُوسَى عَلَيْهِ السَّلَامُ: "هٰذَا مُجَرَّدُ سِحْرٍ. كُلُّ سَحَرَتِي يَسْتَطِيعُونَ فِعْلَ هٰذَا".`,
    ...
    hotspots: [{ id: 'h12-1', x: 35, y: 45, title: 'المعجزات في البلاط', description: 'ألقى موسى عصاه وصارت ثعبانًا وأظهر يده بيضاء.' }, { id: 'h12-2', x: 65, y: 35, title: 'سخرية فرعون', description: 'استهزأ فرعون بمعجزات موسى ووصفها بالسحر.' }],
...
أَمَّا فِرْعَوْنُ فَلَمْ يُؤْمِنْ بِاللهِ، لِأَنَّهُ كَانَ مُتَكَبِّرًا. وَلَمْ يُحِبَّ هٰؤُلَاءِ النَّاسَ لِأَنَّهُمْ آمَنُوا بِاللهِ. فَاسْتَمِرَّ فِي إِيذَاءِ مُوسَى عَلَيْهِ السَّلَامُ وَقَوْمِهِ لَيْلًا وَنَهَارًا.`,
    ...
    hotspots: [{ id: 'h13-1', x: 35, y: 40, title: 'سجود السحرة', description: 'عندما رأى السحرة المعجزة سجدوا موقنين بالحق.' }, { id: 'h13-2', x: 70, y: 50, title: 'الثعبان الضخم', description: 'التهم ثعبان موسى كل ما ألقاه السحرة من خداع.' }],
...
عِنْدَمَا أَشْرَقَتِ الشَّمْسُ، وَصَلُوا إِلَى الْبَحْرِ. وَأَعَدَّ فِرْعَوْنُ جَيْشَهُ الضَّخْمَ.`,
    ...
    hotspots: [{ id: 'h14-1', x: 35, y: 45, title: 'الخروج ليلاً', description: 'خرج بنو إسرائيل بليل سرًا بأمر الله هربًا من فرعون.' }, { id: 'h14-2', x: 65, y: 55, title: 'مسير القافلة', description: 'سارت القافلة ببطء بسبب الأطفال والشيوخ.' }],
...
فَفَتَحَ اللهُ لَهُمْ طَرِيقًا فِي الْبَحْرِ، وَسَارَ مُوسَى عَلَيْهِ السَّلَامُ وَقَوْمُهُ بِأَمَانٍ بَيْنَ جُدْرَانٍ مِنَ الْمَاءِ.`,
    ...
    hotspots: [{ id: 'h15-1', x: 35, y: 45, title: 'ضرب البحر', description: 'أمر الله موسى بضرب البحر بعصاه فانفلق.' }, { id: 'h15-2', x: 65, y: 50, title: 'جُدْرَانُ الْمَاءِ', description: 'سَارَ مُوسَى عَلَيْهِ السَّلَامُ وَقَوْمُهُ بِأَمَانٍ بَيْنَ جُدْرَانٍ مِنَ الْمَاءِ.' }],
...
قِصَّةُ مُوسَى عَلَيْهِ السَّلَامُ تَحْمِلُ دُرُوسًا كَثِيرَةً. فَهِيَ تُخْبِرُنَا أَنَّ النَّاسَ لَيْسُوا مِلْكًا لِأَحَدٍ. وَتُبَيِّنُ لَنَا أَنَّ اللهَ وَحْدَهُ صَاحِبُ الْقُدْرَةِ وَالسُّلْطَانِ.`,
    ...
    hotspots: [{ id: 'h16-1', x: 40, y: 45, title: 'انطباق البحر', description: 'عاد الماء وانطبق على فرعون وجيشه فغرقوا.' }, { id: 'h16-2', x: 65, y: 50, title: 'العبرة والدرس', description: 'القصة تعلمنا أن الظلم عاقبته وخيمة للظالمين.' }],
