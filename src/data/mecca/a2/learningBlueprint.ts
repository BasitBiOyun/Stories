  ...
  chapters: [
    {
      chapterId: 1,
      objectives: [
        L('Identify Bilal’s early place in Islam.', 'يحدد مكانة بلال المبكرة في الإسلام.'),
        L('Explain the lesson about human value in Bilal’s story.', 'يشرح درس قيمة الإنسان في قصة بلال.'),
      ],
      evidencePoints: [
        ...
        { id: 'mecca-a2-c1-slavery', focus: 'direct', claim: L('Bilal was born into slavery.', 'ولد بلال في العبودية.'), evidence: L('Bilal was born into slavery', 'وُلِدَ بِلَالٌ فِي الْعُبُودِيَّةِ') },
      ...
      assessmentItems: [
        ...
        { id: 'mecca-a2-c1-knowledge', learningPointId: 'mecca-a2-c1-slavery', eligibleStages: ['knowledge'], exercise: mc(L('What does the chapter say about Bilal’s birth?', 'ماذا يقول الفصل عن ولادة بلال؟'), { en: ['He was born into slavery', 'He was born as a king', 'He was born in Medina'], ar: ['ولد في العبودية', 'ولد ملكًا', 'ولد في المدينة'] }, 0, L('Bilal’s parents were slaves, so Bilal was born into slavery.', 'كان والداه من العبيد، لذلك ولد بلال في العبودية.')) },
      ...
      ...guideBundle({ focus: L('Bilal’s early place in Islam and the value of every person', 'مكانة بلال المبكرة وقيمة كل إنسان'), primaryQuestion: L('What special first is connected with Bilal?', 'ما الأمر الأول المميز المرتبط ببلال؟'), secondQuestion: L('What lesson does the chapter teach about skin color and slavery?', 'ما الدرس الذي يقدمه الفصل عن لون البشرة والعبودية؟'), grammar: L('Practise was/were for past facts.', 'تدرّب على كان لوصف حقائق الماضي.'), pronunciation: L('Practise Bilal, Adhan, slave, valuable, and free.', 'تدرّب على نطق بِلَال، الْأَذَان، عَبْدًا، قِيمَةً، وحُرًّا.'), fast: L('Write three short facts about Bilal from this chapter.', 'اكتب ثلاث حقائق قصيرة عن بلال من هذا الفصل.'), support: L('Use: “Bilal was ___.” / “His story teaches ___.”', 'استخدم: «كان بلال ___.» / «تعلمنا قصته ___.»') }),
    },
    {
      chapterId: 2,
      objectives: [
        L('Describe social problems in Jahiliyyah.', 'يصف مشكلات المجتمع في الجاهلية.'),
        L('Identify the unfair money practice described in the chapter.', 'يحدد الممارسة المالية الظالمة المذكورة في الفصل.'),
      ],
      evidencePoints: [
      ...
      assessmentItems: [
        ...
        { id: 'mecca-a2-c2-final', learningPointId: 'mecca-a2-c2-faiz', eligibleStages: ['final'], exercise: mc(L('What unfair money practice is described in Chapter 2?', 'ما الممارسة المالية الظالمة المذكورة في الفصل الثاني؟'), { en: ['Lending money and asking for extra money back', 'Giving all money away as a gift', 'Paying workers extra wages'], ar: ['إقراض المال وطلب مال إضافي عند إرجاعه', 'إعطاء المال كله هدية', 'دفع أجور إضافية للعمال'] }, 0, L('The chapter says some rich people lent money to poor people and wanted extra money back.', 'يقول الفصل إن بعض الأغنياء أقرضوا الفقراء المال وطلبوا مالًا إضافيًا.')) },
      ],
      ...guideBundle({ focus: L('Jahiliyyah, the rich-poor gap, and unfair extra money', 'الجاهلية والفجوة بين الغني والفقير والمال الإضافي الظالم'), primaryQuestion: L('How were rich and poor lives different?', 'كيف اختلفت حياة الأغنياء والفقراء؟'), secondQuestion: L('What unfair money practice does the chapter describe?', 'ما الممارسة المالية الظالمة التي يصفها الفصل؟'), grammar: L('Practise there was / there were.', 'تدرّب على كان هناك / كانت هناك.'), pronunciation: L('Practise Jahiliyyah, justice, luxury, poor, rich, and faiz.', 'تدرّب على نطق الْجاهِلِيَّة، عَدَالَة، رَفاهِيَّة، الْفُقَراء، الْأَغْنِياء، وفَيْضًا.'), fast: L('Write two contrasts between rich and poor life.', 'اكتب مقارنتين بين حياة الأغنياء والفقراء.'), support: L('Use: “Rich people ___, but poor people ___.”', 'استخدم: «كان الأغنياء ___، لكن الفقراء ___.»') }),
    },
    {
      chapterId: 3,
      objectives: [
        L('Identify the place of slave markets in Mecca.', 'يحدد مكان أسواق العبيد في مكة.'),
        L('Identify Umayya and his attitude toward Islam.', 'يحدد أمية وموقفه من الإسلام.'),
      ],
      evidencePoints: [
        { id: 'mecca-a2-c3-market', focus: 'direct', claim: L('Mecca was a center for buying and selling slaves.', 'كانت مكة مركزًا لشراء العبيد وبيعهم.'), evidence: L('Mecca was a center for buying and selling slaves', 'مَكَّةُ مَرْكَزًا لِشِرَاءِ الْعَبِيدِ وَبَيْعِهِمْ') },
        { id: 'mecca-a2-c3-umayya', focus: 'direct', claim: L('Umayya b. Halef was Bilal’s master.', 'كان أمية بن خلف سيد بلال.'), evidence: L('His master was Umayya b. Halef', 'سَيِّدُهُ أُمَيَّةُ بْنُ خَلَفٍ') },
        { id: 'mecca-a2-c3-enemy', focus: 'character-action', claim: L('Umayya became a major enemy of Islam and wanted the message to stop.', 'أصبح أمية من أعداء الإسلام وأراد وقف الرسالة.'), evidence: L('became a major enemy of Islam', 'أَعْدَاءِ الْإِسْلَامِ') },
      ],
      vocabularyTargets: vocabularyTargetsFor(3),
      assessmentItems: [
        { id: 'mecca-a2-c3-quick', learningPointId: 'mecca-a2-c3-market', eligibleStages: ['quick'], exercise: tf(L('Mecca was a center for buying and selling slaves.', 'كانت مكة مركزًا لشراء العبيد وبيعهم.'), true, L('This fact is stated directly in the chapter.', 'هذه المعلومة مذكورة مباشرة في الفصل.')) },
        { id: 'mecca-a2-c3-knowledge', learningPointId: 'mecca-a2-c3-umayya', eligibleStages: ['knowledge'], exercise: mc(L('Who was Bilal’s master?', 'من كان سيد بلال؟'), { en: ['Umayya b. Halef', 'Abu Bakr', 'Prophet Şuayb'], ar: ['أمية بن خلف', 'أبو بكر', 'النبي شعيب'] }, 0, L('The chapter names Umayya b. Halef as Bilal’s master.', 'يسمي الفصل أمية بن خلف سيدًا لبلال.')) },
        { id: 'mecca-a2-c3-review', learningPointId: 'mecca-a2-c3-enemy', eligibleStages: ['review'], exercise: tf(L('Umayya wanted the message of Islam to stop.', 'أراد أمية أن تتوقف رسالة الإسلام.'), true, L('The chapter says he opposed Islam and wanted the message to stop.', 'يذكر الفصل أنه عادى الإسلام وأراد وقف الرسالة.')) },
      ],
    ...
    },
    {
      ...
      evidencePoints: [
        { id: 'mecca-a2-c4-camels', focus: 'direct', claim: L('Bilal looked after his master’s camels under the hot sun.', 'كان بلال يرعى جمال سيده تحت حر الشمس.'), evidence: L('looked after his master’s camels', 'يَرْعَى جِمَالَ سَيِّدِهِ') },
        { id: 'mecca-a2-c4-respect', focus: 'character-action', claim: L('Umayya’s family did not respect Bilal as a person.', 'لم تحترم أسرة أمية بلالًا كإنسان.'), evidence: L('did not respect him as a person', 'لَمْ يَحْتَرِمُوهُ كَإِنْسَانٍ') },
        { id: 'mecca-a2-c4-patient', focus: 'theme', claim: L('Bilal had to be patient and work hard every day.', 'كان على بلال أن يكون صبورًا ويعمل بجد كل يوم.'), evidence: L('be patient and work hard every day', 'صَبُورًا') },
      ],
      vocabularyTargets: vocabularyTargetsFor(4),
      assessmentItems: [
        { id: 'mecca-a2-c4-quick', learningPointId: 'mecca-a2-c4-camels', eligibleStages: ['quick'], exercise: mc(L('What work did Bilal do during the day?', 'ما العمل الذي كان بلال يقوم به في النهار؟'), { en: ['He looked after camels under the hot sun', 'He ruled Mecca', 'He made idols'], ar: ['كان يرعى الجمال تحت الشمس الحارة', 'كان يحكم مكة', 'كان يصنع الأصنام'] }, 0, L('Bilal looked after his master’s camels in the desert.', 'كان بلال يرعى جمال سيده في الصحراء.')) },
        { id: 'mecca-a2-c4-review', learningPointId: 'mecca-a2-c4-respect', eligibleStages: ['review'], exercise: tf(L('Umayya’s family respected Bilal as a person.', 'كانت أسرة أمية تحترم بلالًا كإنسان.'), false, L('The chapter says they did not respect him as a person.', 'يقول الفصل إنهم لم يحترموه كإنسان.')) },
    ...
    },
    {
      ...
      evidencePoints: [
        ...
        { id: 'mecca-a2-c5-equal', focus: 'theme', claim: L('The Prophet taught that people must be fair and equal.', 'علم النبي أن الناس يجب أن يكونوا عادلين ومتساوين.'), evidence: L('people must be fair and equal', 'عَادِلِينَ وَمُتَسَاوِينَ') },
      ],
      vocabularyTargets: vocabularyTargetsFor(5),
      assessmentItems: [
        { id: 'mecca-a2-c5-quick', learningPointId: 'mecca-a2-c5-worship', eligibleStages: ['quick'], exercise: tf(L('The new message told people to worship only Allah.', 'دعت الرسالة الجديدة الناس إلى عبادة الله وحده.'), true, L('This is stated directly in the chapter.', 'هذه الرسالة مذكورة مباشرة في الفصل.')) },
        { id: 'mecca-a2-c5-knowledge', learningPointId: 'mecca-a2-c5-freedom', eligibleStages: ['knowledge'], exercise: mc(L('Why did Bilal think he would remain a slave?', 'لماذا ظن بلال أنه سيبقى عبدًا؟'), { en: ['He had no money to pay for his freedom', 'He wanted to remain with Umayya', 'He owned many camels'], ar: ['لم يكن لديه مال ليدفع ثمن حريته', 'كان يريد البقاء مع أمية', 'كان يملك جمالًا كثيرة'] }, 0, L('The chapter says Bilal had no money to pay for his freedom.', 'يقول الفصل إن بلالًا لم يكن لديه مال ليدفع ثمن حريته.')) },
    ...
    },
    {
      ...
      evidencePoints: [
        { id: 'mecca-a2-c6-secret', focus: 'sequence', claim: L('Bilal left secretly and walked on a hidden path.', 'خرج بلال سرًا ومشى في طريق خفي.'), evidence: L('left his room secretly and walked on a hidden path', 'خَرَجَ مِنْ غُرْفَتِهِ سِرًّا وَمَشَى فِي طَرِيقٍ خَفِيٍّ') },
        { id: 'mecca-a2-c6-questions', focus: 'motivation', claim: L('Bilal asked many questions about the new religion.', 'سأل بلال أسئلة كثيرة عن الدين الجديد.'), evidence: L('ask many questions about the new religion', 'أَسْئِلَةً كَثِيرَةً عَنِ الدِّينِ الْجَدِيدِ') },
      ...
      assessmentItems: [
        ...
        { id: 'mecca-a2-c6-review', learningPointId: 'mecca-a2-c6-kind', eligibleStages: ['review'], exercise: tf(L('Abu Bakr was known for being kind to slaves.', 'كان أبو بكر معروفًا بطيبته مع العبيد.'), true, L('The chapter states this about Abu Bakr.', 'يذكر الفصل ذلك عن أبي بكر.')) },
      ],
    ...
    },
    {
      ...
      evidencePoints: [
        { id: 'mecca-a2-c7-accepted', focus: 'turning-point', claim: L('Bilal accepted Islam.', 'دخل بلال في الإسلام.'), evidence: L('he accepted Islam', 'دَخَلَ فِي الْإِسْلامِ') },
        { id: 'mecca-a2-c7-difficult', focus: 'cause-result', claim: L('Bilal knew life would be difficult after becoming a Muslim.', 'عرف بلال أن الحياة ستكون صعبة بعد أن يصبح مسلمًا.'), evidence: L('life would be difficult after becoming a Muslim', 'الْحَياةَ سَتَكُونُ صَعْبَةً بَعْدَ أَنْ يُصْبِحَ مُسْلِمًا') },
    ...
    },
    {
      ...
      assessmentItems: [
        { id: 'mecca-a2-c8-quick', learningPointId: 'mecca-a2-c8-one', eligibleStages: ['quick'], exercise: mc(L('What did Bilal keep saying?', 'ماذا ظل بلال يقول؟'), { en: ['Allah is One', 'Umayya is right', 'I will worship the idols'], ar: ['الله واحد', 'أمية على حق', 'سأعبد الأصنام'] }, 0, L('The chapter repeats Bilal’s statement.', 'يكرر الفصل قول بلال.')) },
    ...
    {
      chapterId: 9,
      objectives: [L('Follow Abu Bakr’s response when he heard Bilal was being hurt.', 'يتتبع استجابة أبي بكر عندما سمع بتعذيب بلال.'), L('Identify Abu Bakr’s question about Bilal’s belief.', 'يحدد سؤال أبي بكر عن إيمان بلال.')],
      evidencePoints: [
      ...
      assessmentItems: [
        ...
        { id: 'mecca-a2-c9-knowledge', learningPointId: 'mecca-a2-c9-sell', eligibleStages: ['knowledge'], exercise: mc(L('What did Abu Bakr ask Umayya to do?', 'ماذا طلب أبو بكر من أمية؟'), { en: ['Sell Bilal to him', 'Give Bilal more work', 'Send Bilal away alone'], ar: ['أن يبيعه بلالًا', 'أن يعطي بلالًا عملًا أكثر', 'أن يرسل بلالًا وحده'] }, 0, L('Abu Bakr asked Umayya to sell Bilal to him.', 'طلب أبو بكر من أمية أن يبيعه بلالًا.')) },
    ...
    },
    {
      ...
      evidencePoints: [
        { id: 'mecca-a2-c10-free', focus: 'turning-point', claim: L('Abu Bakr told Bilal he was now a free man.', 'قال أبو بكر لبلال إنه الآن رجل حر.'), evidence: L('now a free man and no longer a slave', 'رَجُلٌ حُرٌّ وَلَيْسَ عَبْدًا') },
        { id: 'mecca-a2-c10-price', focus: 'direct', claim: L('Umayya agreed to sell Bilal for five pieces of gold.', 'وافق أمية على بيع بلال بخمس قطع من الذهب.'), evidence: L('five pieces of gold', 'بِخَمْسِ قِطَعٍ مِنَ الذَّهَبِ') },
        { id: 'mecca-a2-c10-freed', focus: 'character-action', claim: L('Abu Bakr did not keep Bilal as a slave; he freed him.', 'لم يحتفظ أبو بكر ببلال عبدًا بل جعله حرًا.'), evidence: L('He freed him', 'جَعَلَهُ حُرًّا') },
      ],
      ...
      assessmentItems: [
        ...
        { id: 'mecca-a2-c10-final', learningPointId: 'mecca-a2-c10-freed', eligibleStages: ['final'], exercise: mc(L('What did Abu Bakr do after buying Bilal?', 'ماذا فعل أبو بكر بعد شراء بلال؟'), { en: ['He freed him', 'He kept him as a slave', 'He returned him to Umayya'], ar: ['جعله حرًا', 'أبقاه عبدًا', 'أعاده إلى أمية'] }, 0, L('The chapter says Abu Bakr did not keep Bilal as a slave.', 'يذكر الفصل أن أبا بكر لم يجعل بلالًا عبدًا له بل جعله حرًا.')) },
      ],
      ...guideBundle({ focus: L('the price, rescue, and Bilal’s freedom', 'الثمن والإنقاذ وحرية بلال'), primaryQuestion: L('What price did Umayya accept?', 'ما الثمن الذي وافق عليه أمية؟'), secondQuestion: L('What did Abu Bakr do after buying Bilal?', 'ماذا فعل أبو بكر بعد شراء بلال؟'), grammar: L('Practise became / was now for change of state.', 'تدرّب على أصبح / صار لوصف التغير.'), pronunciation: L('Practise agreed, gold, difficulty, rescued, freely, and free man.', 'تدرّب على نطق وافَقَ، الذَّهَب، بِصُعُوبَة، أَنْقَذَهُ، بِحُرِّيَّة، ورَجُلٌ حُرّ.'), fast: L('Write a before-and-after description of Bilal.', 'اكتب وصفًا لبلال قبل الحرية وبعدها.'), support: L('Use: “After Abu Bakr bought him, Bilal ___.”', 'استخدم: «بعد أن اشتراه أبو بكر، أصبح بلال ___.»') }),
    },
    {
      chapterId: 11,
      ...
      evidencePoints: [
        ...
        { id: 'mecca-a2-c11-brave', focus: 'character-action', claim: L('Bilal remained fearless when people hurt him.', 'بقي بلال ثابتًا بلا خوف عندما آذاه الناس.'), evidence: L('shouted fearlessly', 'بِلا خَوْفٍ') },
      ],
      ...
      assessmentItems: [
        ...
        { id: 'mecca-a2-c11-knowledge', learningPointId: 'mecca-a2-c11-medina', eligibleStages: ['knowledge'], exercise: mc(L('Where did the Muslims move after hardship in Mecca?', 'إلى أين هاجر المسلمون بعد مشقة مكة؟'), { en: ['Medina', 'Babylon', 'Damascus'], ar: ['المدينة', 'بابل', 'دمشق'] }, 0, L('The chapter describes the Hijrah to Medina.', 'يصف الفصل الهجرة إلى المدينة.')) },
        { id: 'mecca-a2-c11-final', learningPointId: 'mecca-a2-c11-brave', eligibleStages: ['final'], exercise: mc(L('Which quality does the chapter emphasize about Bilal before the first Adhan?', 'ما الصفة التي يؤكدها الفصل عن بلال قبل الأذان الأول؟'), { en: ['He was brave and spoke fearlessly', 'He was very wealthy', 'He was a king'], ar: ['كان شجاعًا وثابتًا بلا خوف', 'كان ثريًا جدًا', 'كان ملكًا'] }, 0, L('The chapter describes Bilal as brave and remembers his fearless declaration.', 'يصف الفصل بلالًا بالشجاعة ويذكر ثباته بلا خوف.')) },
      ],
    ...
    },
    {
      ...
      evidencePoints: [
        { id: 'mecca-a2-c12-prayer', focus: 'direct', claim: L('Bilal added the words “Prayer is better than sleep.”', 'أضاف بلال عبارة «الصلاة خير من النوم».'), evidence: L('Prayer is better than sleep', 'الصَّلاةُ خَيْرٌ مِنَ النَّوْمِ') },
        { id: 'mecca-a2-c12-morning', focus: 'direct', claim: L('Bilal used to start the morning call to prayer very early.', 'كان بلال يبدأ أذان الصباح مبكرًا جدًا.'), evidence: L('morning call to prayer very early', 'أَذانَ الصَّباحِ مُبَكِّرًا جِدًّا') },
        { id: 'mecca-a2-c12-equal', focus: 'theme', claim: L('The Prophet taught that all people are equal and no skin color is better than another.', 'علم النبي أن جميع الناس سواء وليس لون بشرة أفضل من آخر.'), evidence: L('all people are equal', 'جَميعَ النّاسِ سَواءٌ') },
      ],
      vocabularyTargets: vocabularyTargetsFor(12),
      assessmentItems: [
        { id: 'mecca-a2-c12-quick', learningPointId: 'mecca-a2-c12-prayer', eligibleStages: ['quick'], exercise: fill(L('Complete the meaning of the phrase Bilal added.', 'أكمل معنى العبارة التي أضافها بلال.'), L('Prayer is better than [blank].', 'الصلاة خير من [blank].'), L('sleep', 'النَّوْمِ'), L('The chapter gives this phrase directly.', 'يعطي الفصل هذه العبارة مباشرة.')) },
        { id: 'mecca-a2-c12-knowledge', learningPointId: 'mecca-a2-c12-morning', eligibleStages: ['knowledge'], exercise: tf(L('Bilal began the morning call to prayer very early.', 'كان بلال يبدأ أذان الصباح مبكرًا جدًا.'), true, L('This appears at the start of the chapter.', 'تظهر هذه المعلومة في بداية الفصل.')) },
        { id: 'mecca-a2-c12-final', learningPointId: 'mecca-a2-c12-equal', eligibleStages: ['final'], exercise: mc(L('Which equality lesson appears in Chapter 12?', 'ما درس المساواة الوارد في الفصل الثاني عشر؟'), { en: ['All people are equal and no skin color is better than another', 'Only rich people are equal', 'People from Mecca are better than everyone'], ar: ['جميع الناس سواء وليس لون بشرة أفضل من آخر', 'الأغنياء فقط متساوون', 'أهل مكة أفضل من الجميع'] }, 0, L('The chapter directly teaches equality and rejects skin-color superiority.', 'يعلم الفصل المساواة مباشرة ويرفض تفضيل لون بشرة على آخر.')) },
      ],
      ...guideBundle({ focus: L('the morning Adhan and the equality message', 'أذان الصباح ورسالة المساواة'), primaryQuestion: L('What phrase did Bilal add?', 'ما العبارة التي أضافها بلال؟'), secondQuestion: L('What did the Prophet teach about skin color?', 'ماذا علّم النبي عن لون البشرة؟'), grammar: L('Practise used to for a repeated past action.', 'تدرّب على التعبير عن العادة الماضية.'), pronunciation: L('Practise morning, pleased, prayer, speech, disrespect, and Farewell Sermon.', 'تدرّب على نطق صَبَاح، فَرِحَ، الصَّلاة، خُطْبَة، عَدَمُ احْتِرَام، وخُطْبَةَ الْوَدَاع.'), fast: L('Write two short facts from the morning Adhan and equality sections.', 'اكتب حقيقتين قصيرتين من قسم أذان الصباح وقسم المساواة.'), support: L('Use: “Bilal added ___.” / “The Prophet taught ___.”', 'استخدم: «أضاف بلال ___.» / «علّم النبي ___.»') }),
    },
    {
      chapterId: 13,
      ...
      evidencePoints: [
        ...
        { id: 'mecca-a2-c13-damascus', focus: 'sequence', claim: L('Bilal went to Damascus and died there.', 'ذهب بلال إلى دمشق وتوفي هناك.'), evidence: L('He went to Damascus and died there', 'دِمَشْقَ') },
      ...
      assessmentItems: [
        ...
        { id: 'mecca-a2-c13-review', learningPointId: 'mecca-a2-c13-damascus', eligibleStages: ['review'], exercise: tf(L('The chapter says Bilal went to Damascus after leaving Medina.', 'يذكر الفصل أن بلالًا ذهب إلى دمشق بعد مغادرة المدينة.'), true, L('The chapter says he went to Damascus and died there.', 'يذكر الفصل أنه ذهب إلى دمشق وتوفي هناك.')) },
        { id: 'mecca-a2-c13-final', learningPointId: 'mecca-a2-c13-equal', eligibleStages: ['final'], exercise: mc(L('What final equality lesson does Bilal’s story show?', 'ما درس المساواة النهائي الذي تبينه قصة بلال؟'), { en: ['Everyone is equal in Islam', 'Only powerful people have value', 'Nationality decides a person’s worth'], ar: ['الجميع سواء في الإسلام', 'الأقوياء وحدهم لهم قيمة', 'الجنسية تحدد قيمة الإنسان'] }, 0, L('The chapter states that everyone is equal in Islam.', 'يذكر الفصل أن الجميع سواء في الإسلام.')) },
      ],
      ...guideBundle({ focus: L('equality, Bilal’s later life, and the importance of heart and actions', 'المساواة وحياة بلال اللاحقة وأهمية القلب والأعمال'), primaryQuestion: L('What does Bilal’s story show about equality?', 'ماذا تبين قصة بلال عن المساواة؟'), secondQuestion: L('What does the chapter say really matters?', 'ما الذي يقول الفصل إنه المهم حقًا؟'), grammar: L('Practise “What matters is ...” for a simple conclusion.', 'تدرّب على «المهم هو...» لكتابة خلاصة.'), pronunciation: L('Practise skin color, nationality, Damascus, matters, and actions.', 'تدرّب على نطق لَوْنِ الْبَشَرَة، الْجِنْسِيَّة، دِمَشْق، الْمُهِمّ، وأَعْمَال.'), fast: L('Write a three-sentence closing summary of Bilal’s story.', 'اكتب خلاصة من ثلاث جمل لقصة بلال.'), support: L('Use: “Everyone is ___.” / “What matters is ___.”', 'استخدم: «الجميع ___.» / «المهم هو ___.»') }),
    },
  ],
  wholeBook: {
