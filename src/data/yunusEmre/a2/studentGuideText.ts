...
export const buildYunusA2GoldStudentGuideText = (blueprint: LearningBlueprint, language: BlueprintLanguage): string => {
  const intro = language === 'en'
    ? '# Yunus Emre A2 — Self-Study Path\n\nUse this guide chapter by chapter. Understand the main event and value, find story evidence, notice useful A2 language, correct mistakes, retrieve the idea later, and express it briefly.'
    : '# يونس إمره A2 — مسار الدراسة الذاتية\n\nاستخدم هذا الدليل فصلًا فصلًا. افهم الحدث الرئيس والقيمة، وحدد دليل القصة، ولاحظ لغة A2 المفيدة، وصحح الأخطاء، واسترجع الفكرة لاحقًا، وعبّر عنها باختصار.';
