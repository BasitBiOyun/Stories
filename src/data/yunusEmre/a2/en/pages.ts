...
In these two stories, Yunus tells us to always remember Allah in our hearts and to do every job well. He says that we must always do our best when we work. Every job is important, so we should do it well and correctly for the love of Allah. Our hearts must be full of love for Him during our daily lives. This helps us live a meaningful and fruitful life.`,
  ...
  { id: 11, type: 'glossary', title: 'Master Glossary - Part 1', content: 'Vocabulary from the first half of the story.', image: 'https://picsum.photos/seed/glossary1-yunus-a2/1200/800', vocabulary: [
    { word: 'poets', definition: 'People who write poems.' }, { word: 'moral', definition: 'About good behavior and right actions.' }, { word: 'dervish', definition: 'A person who follows a simple spiritual life.' }, { word: 'pupil', definition: 'A student.' }, { word: 'witnessed', definition: 'Saw or felt something clearly.' }, { word: 'universe', definition: 'Everything that exists.' }, { word: 'charity', definition: 'Help given to people in need.' }, { word: 'sulky', definition: 'Unhappy and unfriendly in silence.' }, { word: 'honesty', definition: 'Telling the truth and doing what is right.' }, { word: 'patience', definition: 'Staying calm while waiting or facing difficulty.' }, { word: 'humility', definition: 'Not thinking you are better than others.' }, { word: 'moderate', definition: 'Not too much and not too little.' },
  ] },
  { id: 12, type: 'glossary', title: 'Master Glossary - Part 2', content: 'Vocabulary from the second half of the story.', image: 'https://picsum.photos/seed/glossary2-yunus-a2/1200/800', vocabulary: [
    { word: 'humble', definition: 'Not proud; respectful and modest.' }, { word: 'service', definition: 'Work done to help others.' }, { word: 'ordinary', definition: 'Normal or simple.' }, { word: 'crooked', definition: 'Not straight; bent.' }, { word: 'straightest', definition: 'The most straight.' }, { word: 'ego', definition: 'The part of a person that can become proud or selfish.' }, { word: 'corrected', definition: 'Made right or better.' }, { word: 'axe', definition: 'A tool used to cut wood.' }, { word: 'goodness', definition: 'Being good and kind.' }, { word: 'creatures', definition: 'Living things created by Allah.' }, { word: 'deeper meaning', definition: 'A lesson or idea that is not clear at first.' }, { word: 'daisy', definition: 'A small flower.' }, { word: 'meaningful', definition: 'Having an important purpose or value.' }, { word: 'fruitful', definition: 'Useful and successful.' },
  ] },
