...
const yunusA2TeacherGuideFramedEn = buildA2TeacherGuide(yunusA2PagesLockedEn, yunusA2StoryIds, 'en');
const yunusA2TeacherGuideFramedAr = buildA2TeacherGuide(yunusA2PagesLockedAr, yunusA2StoryIds, 'ar');
