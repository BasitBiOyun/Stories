...
const yunusB2CanonicalVocabularyEn: Record<number, StoryVocabulary> = {
  ...
  7: [
    ...
    { word: 'Qur’an', definition: 'the holy book of Islam' },
  ...
  8: [
    ...
    { word: 'source', definition: 'the origin or point from which something comes' },
  ...
  9: [
    ...
    { word: 'Creator', definition: 'Allah as the One who creates' },
...
const yunusB2CanonicalVocabularyAr: Record<number, StoryVocabulary> = {
  ...
  7: [
    ...
    { word: 'الْقُرْآنِ', definition: 'كتاب الإسلام المقدس.' },
  ...
  8: [
    ...
    { word: 'مَصْدَرُ', definition: 'الأصل أو الموضع الذي يأتي منه شيء ما.' },
  ...
  9: [
    ...
    { word: 'الْخَالِقَ', definition: 'الله بوصفه الخالق.' },
