...
const yunusB2CanonicalVocabularyEn: Record<number, StoryVocabulary> = {
  1: [
    ...
    { word: 'prejudice', definition: 'an unfair judgment about people made without sufficient knowledge or experience' },
  ...
  2: [
    ...
    { word: 'widely accepted view', definition: 'an interpretation or opinion that is generally regarded as credible by many people' },
  ...
  8: [
    ...
    { word: 'absolute Oneness', definition: 'complete and indivisible unity, used here for the Oneness of Allah' },
  ...
  9: [
    ...
    { word: 'reflection', definition: 'an image, expression, or representation of something more fundamental' },
    { word: 'commands', definition: 'authoritative instructions or requirements that are expected to be followed' },
  ...
  11: [
    ...
    { word: 'righteous', definition: 'morally good and guided by principles understood as right' },
  ],
  12: [
    ...
    { word: 'slander', definition: 'a false and harmful statement made about another person' },
  ],
  13: [
    ...
    { word: 'patience', definition: 'the ability to endure difficulty without giving up or reacting impulsively' },
...
const yunusB2CanonicalVocabularyAr: Record<number, StoryVocabulary> = {
  1: [
    ...
    { word: 'مَبَادِئَ أَخْلَاقِيَّةٍ', definition: 'معايير توجه الحكم على السلوك والصفات من حيث الصواب والخطأ.' },
    { word: 'تَحَيُّزٍ', definition: 'حكم غير منصف على الناس من دون معرفة أو خبرة كافية.' },
  ...
  2: [
    ...
    { word: 'الرَّأْيِ السَّائِدِ', definition: 'رأي أو تفسير يحظى بقبول واسع ويعده كثير من الناس مرجحًا.' },
  ...
  5: [
    ...
    { word: 'ذَبَحُوا', definition: 'قتلوا أعدادًا من الناس قتلاً عنيفًا وقاسيًا.' },
  ],
  6: [
    ...
    { word: 'إِمَارَاتٍ', definition: 'كيانات أو أقاليم سياسية صغيرة يحكمها أمير أو حاكم محلي.' },
  ...
  8: [
    ...
    { word: 'وَحْدَانِيَّةَ اللَّهِ الْمُطْلَقَةَ', definition: 'الوحدة الكاملة التي لا تقبل الانقسام، ويقصد بها هنا وحدانية الله.' },
  ...
  9: [
    ...
    { word: 'انْعِكَاسٌ', definition: 'صورة أو تعبير يدل على حقيقة أو أصل أعمق.' },
    { word: 'أَوَامِرِ', definition: 'تعليمات أو تكليفات ملزمة يُتوقع اتباعها.' },
  ...
  11: [
    ...
    { word: 'صَالِحَةً', definition: 'متصفة بالخير والاستقامة الأخلاقية.' },
  ],
  12: [
    ...
    { word: 'الْبُهْتَانِ', definition: 'قول كاذب يضر بسمعة شخص آخر.' },
  ],
  13: [
    ...
    { word: 'الصَّبْرِ', definition: 'القدرة على تحمل الصعوبة من غير استسلام أو اندفاع.' },
    { word: 'بَارِزَةً', definition: 'مهمة ومعروفة وذات تأثير واضح.' },
    { word: 'الْأَجْيَالِ الْقَادِمَةِ', definition: 'الناس الذين سيعيشون بعد الجيل الحاضر ويرثون أثره الثقافي.' },
  ],
};
