...
In addition to his standing as a Sûfî, Yunus Emre was one of the Turkish poets to play a crucial role in the development of Old Anatolian Turkish. The words and expressions that he used made a significant contribution to the development of Turkish as a literary language. He established a literary tradition based on Sufism. One of the most important factors in the popularity of Yunus Emre’s works among the public is his style.`,
    ...
    hotspots: [
      { id: 'h1-1', x: 35, y: 45, title: 'Old Anatolian Turkish', description: 'Yunus Emre played a crucial role in the development of Old Anatolian Turkish and established a literary tradition based on Sufism.' },
      { id: 'h1-2', x: 68, y: 52, title: 'Sûfî', description: 'Sûfis maintain a lifestyle within the outer acts of worship and the inner morality and intentions of the heart.' },
    ],
  },
  {
    id: 2,
...
At that time, tekkes were not just an institution that offers Sûfî training but they were also important civil society organizations that strengthened social solidarity and cooperation and also received support from government officials of their time.`,
    ...
    hotspots: [
      { id: 'h2-1', x: 35, y: 45, title: 'Historical accounts', description: 'The chapter qualifies biographical claims with phrases such as “According to historical accounts” and “Some sources note”.' },
      { id: 'h2-2', x: 68, y: 52, title: 'Education', description: 'Yunus received madrasa education and also studied divine love and morals at the tekke under a sheikh.' },
    ],
  },
  {
    id: 3,
...
The rule of the Anatolian Seljuk Sultan Alaeddin I (1220–1237) was the most powerful and glorious period of the Seljuks. He expanded the country’s borders and established a navy in the Mediterranean and Black Seas.`,
    vocabulary: [
      ...
      { word: 'hardships', definition: 'serious difficulties' },
    ],
    hotspots: [
      { id: 'h3-1', x: 35, y: 45, title: 'fine arts', description: 'Tekkes were leading institutions in fine arts like poetry where great masters, including Yunus under Taptuk Emre, were trained.' },
      { id: 'h3-2', x: 68, y: 52, title: 'hard times', description: 'The chapter connects the Babai uprisings, Kösedağ and Mongol invasion with political, economic and social hardship.' },
    ],
  },
  {
    id: 4,
...
Throughout history, societies that faced difficult circumstances have always awaited a divine figure to save them. The Turkmen, too, were awaiting such a figure. In 1240, they rebelled under the leadership of Baba İshak who was the follower of Baba İlyas. Baba İlyas was the founder of a non-Sunni religious–mystical movement.`,
    vocabulary: [
      ...
      { word: 'unrest', definition: 'a state of social disturbance or dissatisfaction' },
    ],
    hotspots: [
      { id: 'h4-1', x: 35, y: 45, title: 'Mongol invasion', description: 'Nomadic Turkmen tribes fleeing the Mongol invasion were exhausted and looking for safe lands to settle in.' },
      { id: 'h4-2', x: 68, y: 52, title: 'Turkmen rebelled', description: 'In 1240, the Turkmen rebelled under Baba İshak, a follower of Baba İlyas.' },
    ],
  },
  {
    id: 5,
...
Finally, in 1243, the Seljuk army and the Mongols clashed at Kösedağ, 80 km northeast of Sivas. The Mongols, using the classic false retreat and circling tactic, wiped out the Seljuk forces. Following their easy victory at Kösedağ, the Mongols destroyed and plundered Sivas, Kayseri, and Erzincan, leaving not a single stone standing. They slaughtered the men with swords; women and children were taken captive and forced to follow the Mongol army. Throughout Yunus’s life, this Mongol storm swept across Anatolia like a roller, leaving behind blood, misery, and ruins. Sources say: “The Mongols slaughtered the people of the great cities and towns so mercilessly that hardly anyone remained there.”`,
    vocabulary: [
      ...
      { word: 'captive', definition: 'a person taken and held by force' },
    ],
    hotspots: [
      { id: 'h5-1', x: 35, y: 45, title: 'false retreat', description: 'At Kösedağ in 1243, the Mongols defeated the Seljuk forces using a false retreat and circling tactic.' },
      { id: 'h5-2', x: 68, y: 52, title: 'victory at Kösedağ', description: 'The text presents Kösedağ as a turning point followed by severe destruction and human suffering.' },
    ],
  },
  {
    id: 6,
...
Statesmen like Celaleddin Karatay, while on the one hand trying to manage the Mongols, were also making efforts to provide some relief to the state and the people. Nevertheless, these efforts were not enough. Finally, in 1308, the lands of Anatolia were directly attached to the Ilkhanate Empire (The Mongol state centred in Iran).`,
    ...
    hotspots: [
      { id: 'h6-1', x: 35, y: 45, title: 'civil officials', description: 'The Seljuks became dependent on the Mongols, with their sultans acting almost like Mongol civil officials.' },
      { id: 'h6-2', x: 68, y: 52, title: 'Ilkhanate Empire', description: 'In 1308, after years of dependency and increasing taxation, Anatolia was directly attached to the Ilkhanate Empire.' },
    ],
  },
  {
    id: 7,
...
Yunus’s understanding of Sûfîsm is based on the Qur’an and the Sunnah, which is the collective term for the Prophet’s sayings, actions, and approvals, as well as on the thoughts and experiences of the Muslim Sûfîs who lived before him. In his poems, he expresses a vivid love for Allah as a way of life, along with fear of Allah and faithfulness to the Prophet Muhammad (pbuh).`,
    ...
    hotspots: [
      { id: 'h7-1', x: 35, y: 45, title: 'Popular Sûfîsm', description: 'Shaykhs under Mongol pressure came to Anatolia and dervishes spread a simple understanding of Islam among nomads.' },
      { id: 'h7-2', x: 68, y: 52, title: 'wise dervish', description: 'Yunus used poetry through his Sûfî identity to respond to people trying to make sense of life in hard times.' },
    ],
  },
  {
    id: 8,
...
As a result of creation, the initial unity disintegrated and multiple existence emerged. Nonetheless, this multiple existence is nothing but manifestations of the names of Allah.`,
    vocabulary: [
      { word: 'tawhid', definition: 'the absolute Oneness of Allah as defined in the chapter' },
      { word: 'vahdet-i vücut', definition: 'In the chapter’s presentation of Yunus Emre’s Sûfî thought: the Unity of Existence.' },
      { word: 'manifestations', definition: 'forms in which something becomes visible or expressed' },
    ],
    hotspots: [
      { id: 'h8-1', x: 35, y: 45, title: 'vahdet-i vücut', description: 'The chapter presents vahdet-i vücut as an idea within Yunus Emre’s Sûfî thought.' },
      { id: 'h8-2', x: 68, y: 52, title: 'true and only reality', description: 'The chapter states that Allah is the source of all things and the true and only reality.' },
    ],
  },
  {
    id: 9,
...
The purpose of love is to reach Allah and achieve unity in His presence. From this perspective, love and unity, which lie at the essence of his thought, are interrelated. For, according to him, where love is absent, negative emotions such as anger, heartbreak and separation arise.`,
    vocabulary: [
      ...
      { word: 'harmony', definition: 'a state of peaceful agreement' },
    ],
    hotspots: [
      { id: 'h9-1', x: 35, y: 45, title: 'love and unity', description: 'The chapter connects love of the Creator and the created with unity and harmony.' },
      { id: 'h9-2', x: 68, y: 52, title: 'Prayer and command', description: 'The quoted verse connects claiming Islam with knowing its requirements and praying the five daily prayers.' },
    ],
  },
  {
    id: 10,
...
Yunus Emre emphasizes not only heart but also intellect as a value, describing it as “a light from Allah that has existed since eternity.” According to him, there are three types of intellect: the practical reason, which enables a person to understand how the world works and sustain worldly life;`,
    ...
    hotspots: [
      { id: 'h10-1', x: 35, y: 45, title: 'center of love', description: 'In Yunus Emre’s philosophy, the heart is the center of love and is described as “the throne of the Lord.”' },
      { id: 'h10-2', x: 68, y: 52, title: 'a light from Allah', description: 'The chapter describes intellect as “a light from Allah that has existed since eternity.”' },
    ],
  },
  {
    id: 11,
...
[/POEM]`,
    ...
    hotspots: [
      { id: 'h11-1', x: 35, y: 45, title: 'heart and reason', description: 'The chapter says heart and reason must support one another for a person to reach salvation.' },
      { id: 'h11-2', x: 68, y: 52, title: 'Death', description: 'Death is presented as an advisor that can help a person live a meaningful and righteous life.' },
    ],
  },
  {
    id: 12,
...
[/POEM]`,
    ...
    hotspots: [
      { id: 'h12-1', x: 35, y: 45, title: 'morality consists', description: 'The chapter presents morality through abandoning harmful behavior and cultivating positive qualities.' },
      { id: 'h12-2', x: 68, y: 52, title: 'negative traits', description: 'Yunus warns against arrogance, anger, stinginess, greed, envy, backbiting and slander.' },
    ],
  },
  {
    id: 13,
...
It is obvious that Yunus Emre was not only a prominent figure in his own time but has also left a lasting legacy. His writings are valuable not only as literary works but also as a moral guide for future generations.`,
    vocabulary: [
      ...
      { word: 'legacy', definition: 'something important handed down to later generations' },
    ],
    hotspots: [
      { id: 'h13-1', x: 35, y: 45, title: 'Moral Legacy', description: 'Yunus Emre’s writings are presented as both literary works and a moral guide for future generations.' },
      { id: 'h13-2', x: 68, y: 52, title: 'future generations', description: 'The final chapter links patience and resistance to anger and arrogance with Yunus Emre’s lasting legacy.' },
    ],
  },
  {
    id: 14,
...
Yeniterzi, Emine. "Mesnevi-i Şerif ve Risaletü’n-Nushiyye’de Ortak Değerler," I. Ulusal Yunus Emre Sempozyumu, Karaman, 2010, s. 101-116.`,
  ...
  { id: 15, type: 'quiz', title: 'Knowledge Check: Yunus Emre - B2', image: 'https://picsum.photos/seed/quiz-yunus-b2/1200/800', audioUrl: '', content: 'Check whole-book comprehension with eight evidence-based questions.' },
  { id: 16, type: 'vocabulary-match', title: 'Vocabulary Challenge', image: 'https://picsum.photos/seed/vocab-match-yunus-b2/1200/800', audioUrl: '', content: 'Match ten important story words with distinct meanings.' },
  { id: 17, type: 'glossary', title: 'Master Glossary - Part 1', image: 'https://picsum.photos/seed/glossary1-yunus-b2/1200/800', content: 'Review chapter vocabulary from the first half of the story.', vocabulary: [] },
  { id: 18, type: 'glossary', title: 'Master Glossary - Part 2', image: 'https://picsum.photos/seed/glossary2-yunus-b2/1200/800', content: 'Review chapter vocabulary from the second half of the story.', vocabulary: [] },
  { id: 19, type: 'exercises', title: 'Retrieval Review', image: 'https://picsum.photos/seed/exercises-yunus-b2/1200/800', content: 'Retrieve, reconnect and use the key learning through four separate activities.' },
  { id: 20, type: 'final-challenge', title: 'Final Challenge: Yunus Emre B2', image: 'https://picsum.photos/seed/challenge-yunus-b2/1200/800', content: 'Demonstrate whole-book mastery through ten independent scored activities.' },
];
