...
import { abrahamB2FinalReviewExercises } from './exercises';

export const abrahamB2Pages: PageData[] = [
  {
    "id": 1,
    "type": "story",
    ...
    "vocabulary": [
      ...
      {
        "word": "fundamental figure",
        "definition": "A central or highly important person in history, a system, or belief."
      }
    ],
    "hotspots": [
      {
        ...
        "x": 30,
        "y": 40,
        "title": "Monotheistic Belief",
        "description": "Abraham (pbuh) was the messenger and representative of this belief."
      },
      {
        "id": "b2-hs-1-2",
        "x": 65,
        "y": 35,
        "title": "Fundamental Figure",
        "description": "He is the core ancestor for Judaism, Christianity, and Islam."
      }
    ],
    "animatedWords": [
      "Idolatry",
    ...
    "exercises": [
      {
        ...
        "options": [
          "Because he was the wealthiest prophet",
          "Because he never questioned the beliefs of his ancestors",
          "Because of his profound dedication, sacrifices, and ultimate trust in Allah"
        ],
        "correctAnswer": 2,
        "explanation": "His unwavering trust and sacrifices earned him this unique title.",
        "feedback": {
          "correct": "Correct! His unwavering trust and sacrifices earned him this unique title.",
  ...
  },
  {
    ...
    "vocabulary": [
      ...
      {
        "word": "existence",
        "definition": "The state or fact of living or being real."
      }
    ],
    "hotspots": [
      {
        ...
        "y": 40,
        "title": "Tawheed",
        "description": "The core belief that Allah is One and has no partners."
      },
      {
        "id": "b2-hs-2-2",
        "x": 65,
        "y": 35,
        "title": "Hanîf",
        "description": "A monotheist who is not an idolater, and is morally upright."
      }
    ],
    "animatedWords": [
      "Idolater",
    ...
    "exercises": [
      {
        ...
        "options": [
          "Through critical reasoning and interpreting the signs of creation",
          "By blindly following ancient traditions",
          "Only through magical signs"
        ],
        "correctAnswer": 0,
        "explanation": "The story emphasizes that pure reasoning leads to the discovery of Tawheed.",
        "feedback": {
          "correct": "Correct! The story emphasizes that pure reasoning leads to the discovery of Tawheed.",
          "incorrect": "Incorrect. Please review the chapter."
        }
      }
    ]
    ...
    "hotspots": [
      {
        ...
        "y": 40,
        "title": "Corrupted",
        "description": "Over time, pure beliefs became mixed with idolatry."
      },
      {
        "id": "b2-hs-3-2",
        "x": 65,
        "y": 35,
        "title": "Ahad",
        "description": "Meaning 'One, One' - declaring the oneness of Allah."
      }
    ],
    "animatedWords": [
      "Idolatry",
