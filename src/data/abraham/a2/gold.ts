...
export const abrahamA2HotspotsGoldEn: A2HotspotMap = {
  ...
  h6: { title: 'The Moon Sets', description: 'When the moon disappeared, Abraham understood that it could not be Allah.' },
  ...
  h18: { title: 'Abraham Trusts Allah', description: 'In the story, Gabriel offered help, but Abraham asked for nothing from him and trusted Allah.' },
...
export const abrahamA2HotspotsGoldAr: A2HotspotMap = {
  ...
  h6: { title: 'القمر يغيب', description: 'عندما غاب القمر فهم إبراهيم أنه لا يمكن أن يكون الله.' },
  ...
  h18: { title: 'إبراهيم يثق بالله', description: 'في القصة عرض جبريل المساعدة، لكن إبراهيم لم يطلب منه شيئا ووثق بالله.' },
