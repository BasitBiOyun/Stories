...
export const abrahamA2HotspotsGoldEn: A2HotspotMap = {
  ...
  h5: { title: 'The Star', description: 'He saw a bright star, but when it disappeared, he would not show respect to it.' },
  ...
  h14: { title: 'These Objects', description: 'Why do you worship these objects? They cannot speak or see and even protect themselves.' },
...
export const abrahamA2HotspotsGoldAr: A2HotspotMap = {
  ...
  h5: { title: 'كوكب', description: 'رأى كوكبًا مضيئًا، ولكن لما غاب قال: لا أحب الآفلين.' },
